...
import { UserpageAdvancedPortfolioPageModernTheme, UserpageAdvancedPortfolioPageNatureTheme } from '@/components/pageLayouts/userpage-adv-port';
  ...
  return (
    ...
    {isAdvancedPortfolioToggled ? (
      <>
        ...
        {(currentAdvancedPortfolioTheme.id === 3 || currentAdvancedPortfolioTheme.themeName === "Nature") && (
          <UserpageAdvancedPortfolioPageNatureTheme {...advProps}/> //NATURE THEME
        )}
