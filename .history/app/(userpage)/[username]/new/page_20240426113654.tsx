...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className='flex  space-x-4 my-14 w-full max-w-screen-md bg-blue-500' style={{fontFamily: `${currentFont.family}`, fontWeight:`${fontWeight}`}}>
        ...
        <div className='bg-red-500 w-full flex-[2.4]'>
          <MainContentPage projects={projects} exps={experiences} userPage={userPage} colorScheme={colorScheme}/>
        </div>
      </div>
