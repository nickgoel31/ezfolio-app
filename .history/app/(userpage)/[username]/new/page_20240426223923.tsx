      ...
      {hasSocialLinks && (
        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3'>
              <Button variant={'outline'} className='text-white' style={{color: `${currentAdvancedPortfolioTheme.secondaryFgColorFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.accentColor}`}}>Talk to me</Button>
              <Link href={"#projects"}>
