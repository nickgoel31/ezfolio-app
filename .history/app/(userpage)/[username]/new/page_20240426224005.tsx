...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      {hasSocialLinks && (
        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3'>
              <Button variant={'outline'} className='text-white' style={{color: `${currentAdvancedPortfolioTheme.primaryBgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.accentColor}`}}>Talk to me</Button>
              <Link href={"#projects"}>
                <Button variant={'default'} style={{color: `${currentAdvancedPortfolioTheme.secondaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.accentColor}`}} >See my projects</Button>
              </Link>
      ...
      <div id='projects' className=' bg-[#FAFAFA] w-full flex flex-col items-center justify-center px-32 pt-16 mx-auto space-x-14 pb-16 text-black space-y-8'>
          <h1 className='text-3xl font-semibold'>
          Projects
          </h1>      
