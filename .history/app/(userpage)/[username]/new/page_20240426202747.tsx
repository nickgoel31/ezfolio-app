...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
          ...
          <div className='flex flex-col gap-8'>
            <div className='flex items-center gap-3'>
              ...
              <div className='flex flex-col '>
                <h3 className='font-medium'>Frontend Developer at <span className='font-bold'>Google</span></h3>
                <p className='text-sm font-medium text-muted-foreground'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione eveniet deserunt est corporis nisi sed!</p>
              </div>
            </div>
        ...
        <div className='flex flex-col flex-[1] space-y-8'>
          ...
          <div className='grid grid-cols-3 gap-8'>
            <div className='flex items-center gap-3'>
              ...
              <div className='flex flex-col '>
                <h3 className='font-medium'><span className='font-bold'>Javascript</span></h3>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='flex flex-col '>
                <h3 className='font-medium'><span className='font-bold'>Next.js</span></h3>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div className=' bg-[#FAFAFA] w-full flex flex-col items-center justify-center px-32 mx-auto space-x-14 py-8 pb-16 text-black space-y-8'>
          <h1 className='text-3xl font-semibold'>
          Projects
          </h1>      
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6'>
              <div className='bg-white rounded-xl p-6 space-y-4'>
                ...
                <p className='font-medium text-muted-foreground'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus dolor obcaecati vero ipsa error? Excepturi quidem sapiente itaque nam quia rem ratione quaerat corrupti error? Voluptas voluptatem quidem impedit sed.
                </p>
      ...
      <div className='py-14 bg-white w-full flex items-center justify-center px-32 mx-auto space-x-10 text-black'>
        <div className='flex flex-col gap-2 items-center justify-center'>
          <h3 className='font-medium text-muted-foreground'>Need Hel</h3>
