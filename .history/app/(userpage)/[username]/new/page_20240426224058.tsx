          ...
          <div className='flex flex-col gap-8'>
            {experiences.map((exp) => (
              <div key={exp.id} className='flex items-center gap-3'>
                <div className='rounded-full p-3 ' style={{color: `${currentAdvancedPortfolioTheme.secondaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.secondaryBgColor}`}}>
                  <Building2 />
                </div>
