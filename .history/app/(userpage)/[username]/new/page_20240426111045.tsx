...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className='flex items-center space-x-4 my-14 w-full max-w-screen-md bg-blue-500'>
        <div className='flex flex-col space-y-4 w-[28%] '>
          <div className='bg-white rounded-lg p-3 flex flex-col items-center justify-center gap-3'>
            ...
            <div className='space-y-1 text-center'>
            <div className='flex items-center gap-2'>
              <h4 className={cn('text-xl ')} style={{color: `${colorScheme.cardFgColorfgColor}`}}>{title}</h4>
              {vipTag && (
                <HoverCard>
                  <HoverCardTrigger>
                    <div style={{color: `${colorScheme.fgColor}`}} className=''>
