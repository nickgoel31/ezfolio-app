...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      {/* <div className=' flex items-center space-x-4 my-14 w-full max-w-screen-md bg-blue-500' style={{fontFamily: `${currentFont.family}`, fontWeight:`${fontWeight}`}}>
      ...
      <div className='flex items-center space-x-4 my-14 w-full max-w-screen-md bg-blue-500' style={{fontFamily: `${currentFont.family}`, fontWeight:`${fontWeight}`}}>
        <div className='flex flex-col space-y-3 w-[28%] '>
          <div className='bg-white rounded-lg p-5 flex flex-col items-center justify-center gap-3'>
            <Avatar className='h-14 w-14'>
              {userPage.pagePicUrl ? (
                <AvatarImage src={userPage.pagePicUrl} alt='Page pic' width={100} height={100} />
              ):(
          ...
          <div className='bg-white rounded-lg p-5 flex flex-col items-center justify-center gap-3'>
            <h1 className='text-sm' style={{fontWeight:`${fontWeight}`,color: `${colorScheme.cardFgColor}`}}>Bio</h1>
            <p className='opacity-80' style={{fontWeight:`${fontWeight-100}`, color: `${colorScheme.cardFgColor}`}} >{bio}</p>
          </div>
