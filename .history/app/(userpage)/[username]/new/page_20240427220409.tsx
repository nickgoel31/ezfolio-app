...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    <>
    <body className='w-full relative flex flex-col items-center justify-start' style={{color: `${currentAdvancedPortfolioTheme.primaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.primaryBgColor}`}}>
    ...
    <div className='sticky bottom-0 w-full bg-white z-[200] border-t border-black border-opacity-10 flex items-center justify-center shadow-md py-3'>
      ...
      <div className='fixed bottom-0 w-full bg-black/50 text-white backdrop z-[200] border-t border-black border-opacity-10 flex items-center justify-center shadow-md py-3'>
