    ...
    <div className='sticky bottom-0 w-full bg-white z-[200] border-t border-black border-opacity-10 flex items-center justify-center shadow-md py-3'>
      ...
      <div className='w-full h-full flex '>
        <div className='flex-[3] w-full h-full relative overflow-hidden'>
          ...
          <div className='w-full h-full z-[4] flex flex-col items-start justify-center px-32 py-16 space-y-16'>
            ...
            <div className='flex w-full gap-6 items-center'>
              <div className='bg-black/20 backdrop-blur-lg p-6 w-full flex-[2]'>
                <div className='flex flex-col space-y-4'>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    <div className='flex items-center justify-start gap-4 text-white'>
                      <div className='bg-black/20 rounded-full p-3 text-white'>
                        <Building2 size={20} />
                      </div>
                      <div className='flex flex-col'>
                        <h3 className='font-semibold'>Software Engineer at Google</h3>
                        <p className='text-muted-foreground'>Building the next big thing</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className='bg-black/20 backdrop-blur-lg p-6 w-full flex-[1]'>
                <div className='flex flex-col'>
