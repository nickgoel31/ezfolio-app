      ...
      {hasSocialLinks && (
        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3 relative'>
              ...
              <div className='absolute bottom-[-100%] left-[0] flex items-end'>
                <p className='font-caveat font-semibold text-lg absolute'>Linkedin</p>
                <Image src={"/arrow-black.png"} alt='arrow'  width={60} height={60} />
