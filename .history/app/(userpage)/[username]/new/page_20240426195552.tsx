...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className='h-[80vh] bg-white w-full flex items-center px-24 mx-auto space-x-10'>
        ...
        <div className='flex flex-col space-y-2 text-black flex-[1]'>
            ...
            <div className='flex gap-4 items-center'>
              <Button variant={'default'}>Talk to me</Button>
              <Button variant={''}>See my projects</Button>
