...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className='h-[80vh] bg-white w-full flex items-center px-32 mx-auto space-x-10 relative'>
      {hasSocialLinks && (
          <div className='socials absolute top-10 left-[50%] translate-x-[-50%] w-full flex items-center justify-start gap-1' style={{ color: `${currentAdvancedPortfolioTheme.primaryFgColor}`}}>
            {userPage.githubUrl && (
