...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className='h-[85vh] bg-white w-full flex items-center px-32 mx-auto space-x-10 relative'>
      {hasSocialLinks && (
      ...
      {experiences.length > 0 && userPage.skills.}
      <div id='projects' className=' bg-[#FAFAFA] w-full flex flex-col items-center justify-center px-32 mx-auto space-x-14 pb-16 text-black space-y-8'>
