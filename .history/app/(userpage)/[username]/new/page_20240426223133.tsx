...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      {hasSocialLinks && (
          <div className='socials absolute top-8 left-[50%] translate-x-[-50%] flex items-center justify-start gap-1' style={{ color: `${currentAdvancedPortfolioTheme.primaryFgColor}`}}>
            {userPage.githubUrl && (
