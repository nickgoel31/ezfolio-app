      ...
      <div className='w-full h-full flex '>
        <div className='flex-[3] w-full h-full relative overflow-hidden'>
          ...
          <div className='absolute top-0 left-0 w-full h-full'>
            <Image src={"/new-port/1-img.jpeg"} alt='thumbnail' width={5000} height={5000} className='w-full h-full object-cover z-[-100]' />
            <span className='bg-black w-full h-full absolute top-0 left-0 opacity-40 '></span>
          </div>

          <div className='w-full h-full z-[4] flex flex-col items-center px-14 py-16'>
