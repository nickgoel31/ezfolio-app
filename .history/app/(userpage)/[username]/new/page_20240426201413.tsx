...
import { Building2, Crown, Diamond, FolderKanban, Gem, LucideDiamond } from 'lucide-react';
...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start'>
      ...
      <div className=' bg-[#FAFAFA] w-full flex items-center px-32 mx-auto space-x-14 py-16 text-black'>
