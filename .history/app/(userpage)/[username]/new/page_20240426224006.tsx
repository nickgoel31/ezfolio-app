      ...
      {hasSocialLinks && (
        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3'>
              ...
              <Link href={"#projects"}>
                <Button variant={'default'} style={{color: `${currentAdvancedPortfolioTheme.secondaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.sec}`}} >See my projects</Button>
              </Link>
