...
// import { getProjectsByUserPageId } from '@/actions/projects/get-project';
// import { getUserPageByUsername } from '@/actions/userpage/get-user-page';
...
// import { getExperiencesByUserPageId } from '@/actions/experience/get-exp';
...
const UserPage = async ({params}:{params:{userName:string}}) => {
  ...
  // const userPage = await getUserPageByUsername(userName)
  ...
  // const projects = await getProjectsByUserPageId(id)
  // const experiences = await getExperiencesByUserPageId(id)
