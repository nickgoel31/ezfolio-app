...
import UserpageAdvancedPortfolioPageModernTheme from '@/components/pageLayouts/userpage-adv-port';
import { getAdvancedPortfolioThemeColorOfAPTheme, getAdvancedPortfolioThemeOfUserPage } from '@/actions/adv-port/get-adv-port';
...
const UserPage = async ({params}:{params:{username:string}}) => {
  ...
  const advProps = {
    ...
    vipTag,
    uniqueTag,
    currentAdvancedPortfolioTheme,
    currentAdvancedPortfolioThemeColor
  };
  ...
  return (
    ...
    {isAdvancedPortfolioToggled ? (
      <>
        {(currentAdvancedPortfolioTheme.id === 1 || currentAdvancedPortfolioTheme.themeName === "Modern") && (
          <UserpageAdvancedPortfolioPageModernTheme {...advProps}/> //MODERN THEME
        )}
        {(currentAdvancedPortfolioTheme.id === 2 || currentAdvancedPortfolioTheme.themeName === "Nature") && (
          <UserpageAdvancedPortfolioPageModernTheme {...advProps}/> //MODERN THEME
        )}
