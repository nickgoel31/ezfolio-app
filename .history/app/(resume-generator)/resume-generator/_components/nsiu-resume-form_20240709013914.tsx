...
import { AwardResume, CertificationResume, EducationResume, ExperienceResume, SkillResume } from "@/types"
    ...
    <>
              ...
              <div className="pt-6">
                {generateResumeModal.values && (
                    <Button type="button" className="w-full">
                        <PDFDownloadLink document={<MyDocumentUNSI skills={skills} experiences={experiences} education={educations} values={generateResumeModal.values} profilePicUrl={profilePicUrl} certifications={certifications} awards={awards}/>} fileName={`${generateResumeModal.values?.name}'s Resume`}>
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full max-w-screen-sm">
                ...
                {/* SECTION 7 */}
                <div className="section-1 space-y-4">
                    <h3 className="text-semibold font-semibold text-lg">6. Add Projects</h3>
