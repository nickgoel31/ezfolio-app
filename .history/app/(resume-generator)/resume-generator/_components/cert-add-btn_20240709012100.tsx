...
import { AwardResume, CertificationResume, EducationResume } from '@/types'


const CertificationAddBtn = ({onCertificationAdd}:{onCertificationAdd: (certification: CertificationResume) => void}) => {
    ...
    const handleAddAward = () => {
        ...
        onCertificationAdd(certification); // Call the function passed from the parent with the experience object
    }
        ...
        <DialogContent>
            ...
            <div className="flex flex-col items-center gap-3 w-full">
                <div className='flex flex-col gap-1 w-full'>
                    ...
                    <Input type="text" placeholder='e.g., UI/UX Design' onChange={(e) => setTitle(e.target.value)} />
                </div>
                <div className='flex flex-col gap-1 w-full'>
                ...
                <div className='flex flex-col gap-1 w-full'>
                    ...
                    <Input type="text" placeholder='e.g., Coursera' onChange={(e) => setIssuingOrg(e.target.value)} />
                </div>
...
export default CertificationAddBtn