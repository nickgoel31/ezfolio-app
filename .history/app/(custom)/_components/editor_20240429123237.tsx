...
import { boilerCodeCss, boilerCodeHtml, files, fontSizeList, themesList } from '@/data/editorData';
            ...
            <div className='flex items-center gap-8'>
                ...
                <div className='gap-2 flex items-center'>
                    <Button variant={"outline"} onClick={() => {
                        setFileName("html")
                    }} size={"sm"} className={cn('text-sm font-medium', fileName === "html" && 'bg-foreground/20')}>Html</Button>
                    <Button variant={"outline"} size={"sm"} onClick={() => {
                        setFileName("css")
                    }} className={cn('text-sm font-medium', fileName === "css" && 'bg-foreground/20')}>Css</Button>
                </div>
            </div>
