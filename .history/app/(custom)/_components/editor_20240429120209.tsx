  ...
  return (
    <div className='w-full h-[94vh] border shadow-sm rounded-xl bg-background relative overflow-hidden'>
        <div className='sticky top-0 w-full h-14 border-b px-4 flex items-center justify-between'>
            <div className='flex items-center gap-8'>
                ...
                <div className='gap-2 flex items-center'>
                    <Button variant={"outline"} onClick={() => {}} size={"sm"} className={cn('text-sm font-medium', htmlEditor && 'bg-foreground/20')}>Html</Button>
                    <Button variant={"outline"} size={"sm"} className={cn('text-sm font-medium', cssEditor && 'bg-foreground/20')}>Css</Button>
                </div>
            </div>
        ...
        <Editor
            ...
            value={htmlEditor ? htmlCode : cssCode}
