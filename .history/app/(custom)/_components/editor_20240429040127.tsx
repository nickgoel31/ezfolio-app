...
const CodeEditor = () => {
  ...
  return (
    <div className='w-full h-full border shadow-sm rounded-xl bg-background relative overflow-hidden'>
        <div className='sticky top-0 w-full h-14 border-b px-4 flex items-center justify-between'>
            <div>
                <Button size={"sm"} className='text-sm font-medium'>Back to dashboard</Button>
            </div>
