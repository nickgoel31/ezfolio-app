        ...
        {currentSection === 5 && <div className='Message 1 leading-normal text-center font-poppins animate-fade-in w-full'>
            ...
            <div className="flex flex-col w-full items-center justify-center gap-2">
                        ...
                        {projects.map((project,index) => (
                            <div key={index} className="p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 w-full max-w-screen-sm">
                                {project.title}
