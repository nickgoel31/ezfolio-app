                ...
                <div className='mt-6 w-full '>
                    ...
                    <div className='flex flex-col gap-3 w-full'>
                        ...
                        <div className='flex flex-wrap gap-3 items-center'>
                            {schemes.map((scheme) => (
                                <div key={scheme.id} className={cn('border p-1 px-3 text-xs font-medium rounded-md bg-foreground/[0.05] cursor-pointer', currentThemeSelected === scheme.id && `bg-[${scheme.firstBgColor}]`)} style={{backgroundColor: `${scheme.firstBgColor}`, color:`${scheme.fgColor}`, background: `linear-gradient(45deg, ${scheme.firstBgColor} 0%, ${scheme.secondBgColor} 50%,${scheme.thirdBgColor} 100%)`}}>
                                    {scheme.name}
                                </div>
                            ))}
                        </div>
