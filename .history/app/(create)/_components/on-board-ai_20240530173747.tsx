            ...
            <div className="flex flex-col w-full items-center justify-center gap-3">
                        ...
                        <div className='absolute bottom-0 left-1/2 -translate-x-1/2 flex items-center gap-4'>
                            ...
                            <DialogTrigger className=''>
                                <div className=" p-3 px-4 border rounded cursor-pointer hover:bg-foreground/50 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.9] text-background justify-between">
