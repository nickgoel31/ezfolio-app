...
const CreateFormImageUpload = () => {
  ...
  return (
    <div className='w-full p-2 flex items-center justify-center'>
        {uploading && (
            <div className='absolute top-10 border shadow-md left-1/2 -translate-x-1/2 p-2 px-3 rounded bg-foreground/10 z-[10] text-sm font-medium flex items-center gap-3'>
                <ColorRing
                visible={true}
                height="25"
                width="25"
