...
import { ColorScheme, PageLayout } from '@prisma/client';
...
const OnBoardingAI = ({username,schemes,layouts,fonts}:{username:string,schemes:ColorScheme[], layouts:PageLayout[], fonts:Font}) => {
