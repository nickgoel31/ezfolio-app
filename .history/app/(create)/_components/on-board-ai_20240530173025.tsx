            ...
            <div className="flex flex-col w-full items-center justify-center gap-3">
                        ...
                        <Dialog>
                            <DialogTrigger className=''>
                                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 bg-back justify-between">
