...
const CreateFormImageUpload = ({defaultImageUrl,addImageUrl}:{defaultImageUrl:string,addImageUrl:(imageUrl:string | null | undefined) => void}) => {
    const [imageUrl,setImageUrl] = useState<string | null | undefined>(defaultImageUrl)
