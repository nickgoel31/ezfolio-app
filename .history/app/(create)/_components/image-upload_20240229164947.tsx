...
const CreateFormImageUpload = () => {
  ...
  return (
    <div className='w-full p-2 flex items-center justify-center'>
        {uploading && (
            <div className='absolute top-10 border shadow-md left-1/2 -translate-x-1/2 p-2 px-4 rounded bg-foreground/10 z-[10] text-sm font-medium flex items-center gap-3 color-ring-wrapper'>
                <ColorRing
                visible={true}
                height="25"
                width="25"
                ...
                colors={['#7C3AED', '#9333EA', '#4F46E5','#9333EA','#9333EA']}
                />
                Uploading image
            </div>
        )}
