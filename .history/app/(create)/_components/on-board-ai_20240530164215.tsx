...
const OnBoardingAI = () => {
    ...
    const section3Submit = (UserPageTitle:string) => {
        setUserDetails({pageTitle:UserPageTitle, pageBio:""})
        setCurrentSection(4)
    }
    ...
    <div className='w-full h-full relative flex items-center justify-center'>
        ...
        {currentSection === 3 && <div className='Message 1 leading-normal text-center font-poppins animate-fade-in'>
            ...
            <div className='relative'>
                ...
                <button className='absolute right-0 top-0 h-full px-4 py-2 bg-violet-500 text-white font-semibold rounded-tr-lg rounded-br-lg' onClick={}>
                    <FaPaperPlane />
                </button>
            </div>
