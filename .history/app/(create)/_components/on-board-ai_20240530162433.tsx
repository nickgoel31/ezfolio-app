...
const OnBoardingAI = () => {
  return (
    <div className='w-full h-full relative flex items-center justify-center'>
        ...
        <div className='Message 1 leading-normal text-c'>
            <h1 className='font-semibold text-4xl'>Hi! I'm EzBuddy</h1>
            <h1 className='font-semibold text-4xl'>your personal Assistant</h1>
        </div>
