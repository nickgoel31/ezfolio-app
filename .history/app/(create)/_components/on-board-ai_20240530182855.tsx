...
import { Replace, SendIcon, Trash2, Trash2Icon } from 'lucide-react';
    ...
    <div className='w-full h-full relative flex items-center justify-center max-w-screen-md mx-auto'>
        ...
        {currentSection === 6 && <div className='Message 1 leading-normal text-center font-poppins animate-fade-in'>
            <h1 className='font-semibold text-4xl leading-normal'>Great! What else would <br />you like to add?</h1>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mt-8'>
                    {!imageUrl && <div className=" p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.05] justify-between" onClick={() => setCurrentSection(7)}>
                        <h5 className="font-medium text-sm">Profile Picture</h5>
                    </div>}

                    <div className=" p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.05] justify-between items-center text-center" onClick={() => setCurrentSection(8)}>
        ...
        {currentSection === 8 && (
            <div className='Message 1 leading-normal text-center font-poppins animate-fade-in'>
                ...
                {<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mt-8'>
                    <div className=" p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.05] justify-between" onClick={() => setCurrentSection(8)}>
                        <h5 className="font-medium text-sm">Experience</h5>
                    </div>
                </div>}
