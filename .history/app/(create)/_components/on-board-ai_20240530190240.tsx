            ...
            <div className='Message 1 leading-normal text-center font-poppins animate-fade-in'>
                ...
                <div className='flex gap-2 flex-wrap mt-6'>
                    {skillsArrayState.map((sk,index) => (
                        <div key={index} className='p-2 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.05] justify-center text-xs'>
                            {sk}
                        </div>
                    ))}
                </div>
