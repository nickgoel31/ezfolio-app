  ...
  return (
    <div className='w-full p-2 flex items-center justify-center'>
        <div className='h-20 w-20 bg-foreground/10 rounded-full overflow-hidden flex items-center justify-center group relative cursor-pointer transition'>
            <span className='bg-black/40 w-full h-full rounded-full absolute group-hover:flex hidden items-center justify-center transition'>+
            </span>
            <p className='text-xs font-medium group-hover:hidden transition'>Upload</p>
        </div>
    </div>
  )
}
