        ...
        {currentSection === 6 && <div className='Message 1 leading-normal text-center font-poppins animate-fade-in'>
            <h1 className='font-semibold text-4xl leading-normal'>Great! What else would <br />you like to add?</h1>
                ...
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 p-3 px-4 border rounded cursor-pointer hover:bg-foreground/60 transition font-medium text-sm flex items-center gap-4 bg-foreground/[0.9] text-background justify-between overflow-hidden transition-ez hover:text-foreground group" onClick={section5Submit}>
                    <span className='absolute w-full h-full z-[-1] bg-gradient-to-tr from-violet-500 to-fuchsia-500 left-0 translate-x-full translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 transition-ez opacity-0 group-hover:opacity-100'></span>
