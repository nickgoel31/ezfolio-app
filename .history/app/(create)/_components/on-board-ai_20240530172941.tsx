            ...
            <div className="flex flex-col w-full items-center justify-center gap-3">
                        ...
                        <Dialog>
                            <DialogTrigger className=''>
                                <div className="absolute p-3 px-4 border rounded cursor-pointer hover:bg-foreground/10 transition font-medium text-sm flex items-center gap-4 w-full max-w-screen-sm justify-between">
