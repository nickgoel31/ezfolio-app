...
const OnBoardingAI = () => {
  ...
  return (
    <div className='w-full h-full relative flex items-center justify-center max-w-screen-md mx-auto'>
        ...
        {currentSection === 10 && (
            <div className='Message 1 leading-normal text-center font-poppins animate-fade-in w-full'>
                <h1 className='font-semibold text-2xl leading-normal'>Set Appearance of your page<br /></h1>
