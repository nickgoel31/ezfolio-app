...
const OnBoardingForm = () => {
    ...
    const isFormValid = isValid && projects.length > 0;
      ...
      function onSubmit(values: z.infer<typeof onBoardingSchema>) {
        createUserPageInDB(values,projects)
      }
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full max-w-screen-sm mx-auto">
        {isFirstSection && (
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <div className=" overflow-hidden relative">
                        ...
                        <div className="">
                            <Input placeholder="username" className="pl-24 bg-foreground/10 border" {...field} />
                        </div>
                    </div>
                </FormControl>
                <FormMessage />
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <div className=" overflow-hidden relative">
                        {/* <div className="absolute top-0 h-full left-0 flex items-center justify-center px-4 text-muted-foreground text-sm font-medium">Linkin.tech/</div> */}
                        <div className="">
                            <Input placeholder="Email" className=" bg-foreground/10 border" {...field} />
                        </div>
                    </div>
                </FormControl>
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <div className=" overflow-hidden relative">
                        {/* <div className="absolute top-0 h-full left-0 flex items-center justify-center px-4 text-muted-foreground text-sm font-medium">Linkin.tech/</div> */}
                        <div className="">
                            <Input placeholder="Password" type="password" className=" bg-foreground/10 border" {...field} />
                        </div>
                    </div>
                </FormControl>
            ...
            }} type="button" className="w-full">Next</Button>
            </div>
        )}
        ...
        {/* {isThirdSection && (
            ...
            <div className="flex w-full gap-3 items-center">
                    ...
                    <Button type="submit" disabled={!isFormValid} className="w-full flex-1">Submit</Button>
                </div>
            </div>
        )} */}
      </form>
