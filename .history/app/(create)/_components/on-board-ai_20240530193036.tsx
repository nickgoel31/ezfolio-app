                ...
                <div className='mt-6 w-full '>
                    ...
                    <div className='flex flex-col gap-3 w-full'>
                        ...
                        <div className='flex flex-wrap gap-3 items-center'>
                            {schemes.map((scheme) => (
                                <div key={scheme.id} className={cn('border p-1 px-3 text-xs font-medium rounded-md bg-foreground/[0.05] cursor-pointer', currentThemeSelected === scheme.id && `bg-[${scheme.}]`)}>
                                    {scheme.name}
                                </div>
                            ))}
                        </div>
