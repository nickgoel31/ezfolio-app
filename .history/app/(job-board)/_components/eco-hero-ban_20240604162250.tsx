...
const EzConnectHeroBanner = () => {
  return (
    <div className='w-full h-[calc(100vh-var(--navbar-height))] relative flex flex-col items-center justify-center space-y-3 overflow-x-hidden px-8 antialiased max-w-screen-lg mx-auto'>    
      ...
      >
          <div className='flex-[1.5] flex flex-col gap-2 relative w-full items-center'>
            <h1 className='font-bold text-3xl md:text-4xl xl:text-5xl leading-normal'>Connect with Developers.&nbsp;
            </h1>
            <h1 className='font-bold text-3xl md:text-4xl xl:text-5xl leading-normal'><span className='bg-gradient-to-r font-bold leading-normal hero-gradient-text from-violet-500 to-indigo-500 bg-clip-text text-transparent'>EzConnect</span>&nbsp;them.</h1>
            ...
            <div className='flex-[1] w-full'>
              <div className='overflow-hidden w-[800px] h-[550px]'>
