                ...
                <div className='w-full gap-2 flex flex-col text-sm font-medium pt-2'>
                    ...
                    <div className='absolute bottom-6 px-4 left-0 w-full '>
                        <div className='w-full justify-center flex items-center gap-3'>
                            <Button variant={"outline"} className='flex w-full'>View thier profile</Button>
                            <Popover>
                                <PopoverTrigger>
                                    <Button variant={"outline"} size={"icon"} className='flex w-full'><MoreVertical size={20}/></Button>
                                </PopoverTrigger>
