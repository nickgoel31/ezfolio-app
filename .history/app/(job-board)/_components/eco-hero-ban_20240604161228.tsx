...
const EzConnectHeroBanner = () => {
  return (
    <div className='w-full h-[calc(100vh-var(--navbar-height))] relative flex flex-col  justify-center space-y-3 overflow-x-hidden px-32 antialiased'>    
        {/* <BackgroundBeams /> */}
        <motion.div
      ...
      >
          <div className='flex-[1.2] flex flex-col gap-2 relative'>
