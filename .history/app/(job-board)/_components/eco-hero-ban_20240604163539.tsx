      ...
      >
          <div className='flex-[1.5] flex flex-col gap-2 relative w-full justify-center'>
            ...
            <div className='relative flex-[1] w-full h-full'>
              <div className='absolute w-[36rem] h-[24rem] top-1/2 -translate-y-[calc(50%-4rem)] left-0 shadow-2xl overflow-hidden rounded-lg z-[2]'>
              <span className='absolute bg-foreground/[0.01] top-0 left-0 w-full h-full'></span>
              ...
              <div className='absolute w-[36rem] h-[20rem] top-1/2 -translate-y-[calc(50%)] left-[2rem] shadow-2xl overflow-hidden rounded-lg'>
                <span className='absolute bg-foreground/5 top-0 left-0 w-full h-full'></span>
