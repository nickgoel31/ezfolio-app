...
const QuestionPostContent = ({question}:{question:QuestionPost}) => {
    ...
    const htmlDesc = marked(question.description)
  ...
  return (
    <div className='space-y-6  '>
        ...
        <TiptapQuestionReadOnly description={question.description} isPostCreator={isPostCreator} questionPostId={question.id}/>
    </div>
  )
}
