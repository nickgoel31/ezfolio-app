        ...
        {answers.map((answer) => {
            ...
            return (
                <div key={answer.id} className='px-4 space-y-2'>
                    <p className='font-medium leading-normal text-sm text-muted-foreground'><span className='font-bold text-foreground'>Answered by&nbsp;</span>{answer.userId} | {formattedDate}</p>
