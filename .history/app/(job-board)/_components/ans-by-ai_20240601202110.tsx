...
const AnswerByAI = async ({question}:{question:QuestionPost}) => {
  ...
  return (
    <div className='flex flex-col gap-font-medium text-sm dark:text-violet-200 text-violet-800 w-full p-4 border rounded-lg bg-violet-900/10 border-violet-600/20'>
