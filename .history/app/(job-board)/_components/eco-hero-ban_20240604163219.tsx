      ...
      >
          <div className='flex-[1.5] flex flex-col gap-2 relative w-full justify-center'>
            ...
            <div className='relative flex-[1] w-full h-full '>
              <div className='absolute w-[36rem] h-[24rem] top-1/2 -translate-y-[calc(50%-40px-4rem)] left-0 shadow-2xl overflow-hidden rounded-lg z-[2]'>
                <Image src={'/connect-banner-1.jpg'} alt='connect-banner-1' width={1000} height={1000} className='w-full h-full'/>
              </div>

              <div className='absolute w-[36rem] h-[21rem] top-1/2 -translate-y-[calc(50%)] left-0 shadow-2xl overflow-hidden rounded-lg'>
