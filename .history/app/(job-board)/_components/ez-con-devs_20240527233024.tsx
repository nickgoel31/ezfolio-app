  ...
  return (
    <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        {userPages.slice(0,20).map((user,index) => (
            <div key={index} className='w-full bg-foreground/[0.02] relative rounded-lg border border-foreground/5 h-80 p-4 py-6 gap-3 flex flex-col items-center'>
                ...
                <div className='w-full gap-2 flex flex-col text-sm font-medium pt-2'>
                    ...
                    <div className='absolute bottom-0 left-0 w-full p-2 bg-red-500'>
