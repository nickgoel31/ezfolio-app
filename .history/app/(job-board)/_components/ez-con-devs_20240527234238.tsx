                            ...
                            <Popover>
                                ...
                                <PopoverContent>
                                    <div className='flex flex-col w-full'>
                                        <Button variant={"ghost"} className='w-full flex items-center justify-start gap-3'><FaPaperPlane />Message them</Button>
                                        <Button variant={"ghost"} className='w-full flex items-center justify-start gap-3'><Mail />Email them</Button>
                                    </div>
                                </PopoverContent>
                            </Popover>
