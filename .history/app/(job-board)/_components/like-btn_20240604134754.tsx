...
const LikeBtn = ({currentUser,questionId}:{currentUser:User, questionId:string}) => {
  ...
  return (
        <div onClick={handleLikePost} className={cn('fixed bottom-10 right-10 font-medium z-[80] p-3 rounded-full bg-foreground text-background cursor-pointer', liked && 'bg-violet-500 ')}>
