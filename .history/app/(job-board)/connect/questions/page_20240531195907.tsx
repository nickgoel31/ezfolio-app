      ...
      <div className='space-y-14 lg:px-24'>
        <div className='flex items-center justify-between w-full'>
            ...
            <div className='relative flex items-center gap-2 overflow-hidden rounded-lg border w-64'>
                ...
                <div className='absolute right-0 top-0 h-full px-2 py-0.5 flex items-center justify-center bg-foreground/[0.1] text-white font-semibold rounded-tr-lg rounded-br-lg'>
                    <Search size={20}/>
                </div>
            </div>
        </div>
