            ...
            <Suspense>
              <div className='bg-foreground/5 rounded-lg p-3 px-4 font-medium'>
                ...
                <div className='pt-4 space-y-3'>
                  ...
                  return(
                    <div key={ques.id}>
                      <Link className='text-sm font-normal underline underline-offset-2 text-muted-foreground flex items-center justify-between w-full' href={`/connect/questions/${ques.id}`}>
                        <p>{ques.title}</p>
