        ...
        <div className='flex gap-4'>
          <div className='grid grid-cols-1 w-full gap-4 flex-[3]'>
            {questionPosts.map((q)=> {
              ...
              // Sample HTML text
              const htmlText = `<pre class="p-1 px-2 rounded-md bg-foreground/[0.1]"><code>hfdhfdhfhfg jhghyhg jhkhk</code></pre><h2 style="text-align: center" class="text-3xl font-semibold"></h2><p style="text-align: center">Hleoieriufewhifg</p>`;
