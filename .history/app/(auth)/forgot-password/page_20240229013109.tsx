...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center space-y-3 max-w-[400px]'>
        ...
        {error && (
          <div className="border border-red-500 bg-red-500/10 p-4 rounded w-full text-sm font-medium text-red-500 flex items-center gap-3">
        ...
        {success && (
          <div className="border border-emerald-500 bg-emerald-500/10 p-4 rounded w-full text-sm font-medium text-emerald-500 flex items-center gap-3">
            <AlertTriangle size={20}/>
            {success}
          </div>
        )}
