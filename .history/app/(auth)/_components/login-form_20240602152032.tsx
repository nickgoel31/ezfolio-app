      ...
      {error && (
        ...
        {!twoFADialog && (
          <div className="w-full h-full absolute top-0 left-0 z-[60] bg-background/5 backdrop-blur-lg flex items-center justify-center">
            <div className="p-10 w-[90%] max-w-[500px] items-center justify-center flex border bg-background rounded-lg">
              <h2 className="font-semibold text-3xl text-center">Your 6 digit code</h2>
            </div>
          </div>
        )}
