...
const VerifyEmailPage = () => {
    ...
    const isValidToken = checkEmailVerificationToken(emailVerificationTokenFromDB)
    ...
    updateEmailVerified(emailVerificationTokenFromDB.userEmail,emailVerificationTokenFromDB.token).then(d=> {
