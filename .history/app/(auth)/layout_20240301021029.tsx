...
const AuthLayout = ({children}:{children:React.ReactNode}) => {
  return (
    <body className='relative h-full w-full bg-background overflow-hidden'>
      ...
      <div className="hidden dark:block absolute top-0 z-[-2] h-screen w-screen rotate-180 transform  bg-[radial-gradient(60%_120%_at_50%_50%,hsla(0,0%,100%,0)_0,#7C3AED30_100%)]"></div>
