...
const SettingsSidebar = () => {
  ...
  return (
      <ul className='flex flex-col'>
        ...
        <li className="mt-5 cursor-pointer border-l-2 border-l-blue-700 px-2 py-2 font-semibold text-blue-700 transition hover:border-l-blue-700 hover:text-blue-700">{pathname}</li>
      </ul>
  )
}
