       ...
       <section className='space-y-8'>
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-muted-foreground">Are you <span className='font-bold text-blue-500'>sure?</span></p>
                    <button className="inline-flex text-sm font-semibold text-indigo-500 underline decoration-2">Delete</button>
                </div>
            </div>
       </section>
    </div>
