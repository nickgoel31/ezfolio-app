      ...
      <hr className="mt-4 mb-8" />
       ...
       <section className='space-y-8'>
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-muted-foreground">
                        You have <span className={cn(`font-bold`, user.twoFactorAuthentication ? `text-emerald-500` : `text-red-500`)}>{user.twoFactorAuthentication ? `Enabled` : `Not Enabled`} 2FA</span>
                    </p>
                    <button className="inline-flex text-sm font-semibold text-blue-600 underline decoration-2">Enable</button>
                </div>
            </div>
       </section>
    </section>
