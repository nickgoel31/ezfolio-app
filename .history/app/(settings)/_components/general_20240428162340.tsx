      ...
      <hr className="mt-4 mb-8" />
       ...
       <section className='space-y-8'>
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-muted-foreground">Your email address is <span className={cn(`font-bold`, user.emailVerified ? `text-emerald-500` : `text-red`)}>{user.emailVerified ? `Verified` : `Not Verified`}</span></p>
                </div>
            </div>
       </section>
    </div>
