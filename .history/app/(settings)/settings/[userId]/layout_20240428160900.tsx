...
const SettingsLayout = ({params, children}:{children:React.ReactNode, params: {userId:string}}) => {
  return (
    <div className='mx-0 px-4 h-screen w-full bg-background text-foreground'>
        <div className="h-full max-w-screen-lg mx-auto">
            ...
            <div className='grid grid-cols-8 pt-3 sm:grid-cols-10'>
                ...
                <div className='h-full col-span-8 overflow-hidden rounded-xl bg-foreground/5 sm:px-8 sm:shadow'>
                    {children}
                </div>
            </div>
        </div>
