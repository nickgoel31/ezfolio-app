...
const NotSignedInUserFormForCreatingResume = () => {
  ...
  return (
    <body className='relative w-full min-h-screen flex items-center justify-center flex-col gap-4 font-poppins'>
        ...
        <div className='w-full max-w-screen-sm mx-auto flex flex-col gap-4 h-full py-32'>
