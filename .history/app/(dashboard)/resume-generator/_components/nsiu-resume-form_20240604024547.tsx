        ...
        {generateResumeModal.status && (
            ...
            <div className="p-9 w-[90%] max-w-[500px] items-center justify-center flex border bg-background rounded-lg flex-col">
              ...
              <div className="pt-6">
                {generateResumeModal.values && (
                    <Button type="button" className="w-full">
                        <PDFDownloadLink document={<MyDocumentUNSI skills={skills} experiences={experiences} education={educations} values={generateResumeModal.values} profilePicUrl={profilePicUrl}/>} fileName={`${generateResumeModal.values?.name}'s Resume`}>
              ...
              <div className="pt-6 w-full">
                <div className='w-full py-9 px-5 bg-gradient-to-tr from-teal-400 via-indigo-400 to-rose-400 rounded-lg'>
                    <h1>Ezfolio</h1>
                    <p>
                        Ezfolio is a platform that allows you to create your resume with ease. It provides you with a variety of templates to choose from. You can add your experiences, education, skills and generate your resume with just a click.
                    </p>
                </div>
              </div>
            </div>
