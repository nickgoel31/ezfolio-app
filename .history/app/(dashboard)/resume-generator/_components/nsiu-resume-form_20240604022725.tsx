...
const ResumeGeneratorFormNSIU = () => {
    ...
    const [profilePicUrl,setProfilePicUrl] = useRef<HTMLInputElement>(null);

    const [selectedTheme, setSelectedTheme] = useState<number>(1);

    const [generateResumeModal, setGenerateResumeModal] = useState<boolean>(true)
  ...
  return (
    <>
        {generateResumeModal && (
            <div className='w-screen h-screen z-[80] '>
            ...
            <div className="p-6 w-[90%] max-w-[500px] items-center justify-center flex border bg-background rounded-lg flex-col">
              ...
              <div className="pt-6">
                <Button type="button" className="w-full">
                    <PDFDownloadLink document={<MyDocumentUNSI skills={skills} experiences={projectsAndExps.experiencesState} projects={projectsAndExps.projectsState} awards={projectsAndExps.awardsState} education={projectsAndExps.educationState}/>} fileName={`${userPage.title}'s Resume`}>
