  ...
  return (
    <body className='w-full flex items-center justify-center flex-col gap-4 font-poppins'>
        ...
        <div className='fixed bottom-0 left-0 w-full p-4 border-t bg-background/10 backdrop-blur-xl'>
          <p className='font-medium text-muted-foreground text-center text-sm'>Sign up on Ezfolio to create online portfolios and showcase it to the world! <span className='font-semibold text-violet-500 dark:text-violet-400'>Join Now</span></p>
        </div>
