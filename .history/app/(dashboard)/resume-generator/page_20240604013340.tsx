    ...
    <body className='relative w-full h-full flex items-center justify-center flex-col gap-4 font-poppins'>
        ...
        <div className='w-full max-w-screen-sm mx-auto flex flex-col gap-4'>
            ...
            <div className='w-full flex items-center justify-center pt-2'>
                <Button>
                    <PDFDownloadLink document={<MyDocument userPage={userPage} experiences={projectsAndExps.experiencesState} projects={projectsAndExps.projectsState} awards={projectsAndExps.awardsState} education={projectsAndExps.educationState}/>} fileName={`${userPage.title}`}>
