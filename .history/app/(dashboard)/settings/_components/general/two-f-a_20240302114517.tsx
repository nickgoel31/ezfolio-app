...
const TwoFAuth = () => {
  return (
    <div className='space-y-3'>
        ...
        <p className='font-medium text-destructive dark:text-red-500 '>Two Factor authentication is not enabled! It can pose a risk to your account safety and integrity</p>
    </div>
  )
}
