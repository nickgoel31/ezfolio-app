...
const NewProjectForm = ({ userPageId, onProjectAdded }: { userPageId: string; onProjectAdded: (project: ProjectStateType) => void }) => {

  const [project,setProject] = useState<ProjectStateType | undefined>()
