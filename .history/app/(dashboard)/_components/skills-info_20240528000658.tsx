...
import { popularSkills, techSkills } from '@/data/skills'
                        ...
                        <div className='flex items-start justify-start '>
                            <Command>
                                ...
                                <CommandList>
                                    ...
                                    {popularSkills.slice(0,4).map((pop,index) => (
                                        <CommandItem key={index}>{pop}</CommandItem>
                                    ))}
                                    </CommandGroup>
                                    <CommandSeparator />
                                    <CommandGroup heading="Technical Skills">
                                    {techSkills.map((tech,index) => (
                                        <CommandItem>{tech}</CommandItem>
                                    ))}
                                    </CommandGroup>
                                </CommandList>
                            </Command>
