  ...
  return (
    <div className='p-3 px-4 flex flex-col gap-2'>
        ...
        <div className='grid grid-cols-2 gap-2 items-center w-full'>
            ...
            <div className='border-b border-foreground/50 cursor-pointer hover:bg-foreground/5 text-sm font-semibold items-center justify-center w-full text-center py-1'>
                Others
            </div>
        </div>
    </div>
