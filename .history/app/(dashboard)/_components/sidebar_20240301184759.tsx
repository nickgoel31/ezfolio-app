...
export const UpdatedSidebar = ({userId,username}:{userId:string,username:string}) => {
    ...
    return (
        <div className='hidden lg:block  w-full'>
            ...
            className={cn('updated-sidebar cursor-pointer rounded-xl bg-gradient-to-t from-violet-950/10 to-background border p-5 font-semibold text-lg z-[101] fixed top-8 left-12 transition h-[80px] flex flex-col items-center justify-start overflow-hidden', sidebarOpen && 'h-80')}>
                <span className='absolute bottom-0 w-2 h-2 bg-white rounded-full left-1/2 -translate-x-1/2'/>
