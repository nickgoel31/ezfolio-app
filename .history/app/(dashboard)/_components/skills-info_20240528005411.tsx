                        ...
                        <div className='flex items-start justify-start '>
                            <Command>
                                ...
                                <CommandList className=''>
                                    ...
                                    <CommandGroup heading="Suggestions" className='space-y-1'>
                                    {popularSkills.map((pop,index) => (
                                        <div key={index} className={cn('w-full rounded-md', selectedSkills.includes(pop) && 'bg-foreground/90 text-background')} onClick={() => handleSelectSkill(pop)}>
                                            <CommandItem  >
                                                {pop}
                                            </CommandItem>
                                        </div>
