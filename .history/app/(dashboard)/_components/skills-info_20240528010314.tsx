...
const SkillsInfo = ({skills, userPageId}:{skills:string[],userPageId:string}) => {
    ...
    const handleAddSkill = () => {
        addSkillsInDB(selectedSkills,userPageId)
    ...
    <div className='w-full flex flex-col space-y-4'>
        ...
        <div className='flex flex-wrap flex-row md:flex-row items-center gap-3'>
            ...
            <div>
                <Dialog>
                    <DialogTrigger>
                        <div className='border bg-foreground text-background rounded-lg p-3 shadow-sm bg-background hover:bg-neutral-100/5 cursor-pointer transition'>
