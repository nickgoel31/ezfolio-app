    ...
    <div className='w-full flex flex-col space-y-4'>
        ...
        <div className='space-y-4'>
            <div className='grid grid-cols-1 gap-4  w-full lg:grid-cols-2'>
                <div className='border shadow-sm rounded-xl p-3 px-5 w-full space-y-2 relative bg-foreground/5'>
                    <div className='flex items-center gap-2'>
                        <FaGithub size={17}/>
                        <h6 className='font-medium'>Github</h6>
                    </div>
                    <Input className='dark:bg-[#070b17]' defaultValue={githubUrl || ""} placeholder='https://www.github.com/nickgoel31' type='url' onChange={(e) => setGithubUrl(e.target.value)}/>
                </div>

                <div className='border shadow-sm rounded-xl p-3 px-5 bg-foreground/5 w-full space-y-1 relative'>
                    <div className='flex items-center gap-2'>
                        <FaLinkedin size={17}/>
                        <h6 className='font-medium'>Linkedin</h6>
                    </div>
                    <Input className='dark:bg-[#070b17]' defaultValue={linkedinUrl || ""} placeholder='https://www.linkedin.com/nickgoel31' type='url' onChange={(e) => setLinkedinUrl(e.target.value)}/>
                </div>

                <div className='border shadow-sm rounded-xl p-3 px-5 bg-foreground/5 w-full space-y-1 relative'>
                    <div className='flex items-center gap-2'>
                        <FaInstagram size={217}/>
                        <h6 className='font-medium'>Instagram</h6>
                    </div>
                    <Input className='dark:bg-[#070b17]' defaultValue={instagramUrl || ""} placeholder='https://www.instagram.com/nickgoel31' type='url' onChange={(e) => setInstagramUrl(e.target.value)}/>
                </div>    
            </div>
