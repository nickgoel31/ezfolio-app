                ...
                <div>
                    ...
                    <div className='space-y-2 w-full items-center justify-center flex flex-col'>
                        ...
                        <Link href={`/connect`} className='relative group flex items-center gap-3 text-sm font-medium rounded hover:bg-foreground/5 p-2'>
                            <Users size={18}/>
                            <p className='absolute left-0 translate-x-[calc(5vw)] font-medium text-sm p-1 px-2 rounded-md bg-violet-950border text-violet-200 group-hover:block hidden animate-fade-in duration-75'>EzConnect</p>
                        </Link>
