    ...
    <div className={cn("share-div", isOpen ? "min-w-[26vw] p-3 px-4 flex flex-col gap-2" : "p-2 px-3 min-w-0 ")}>
        ...
        {isOpen && isOthersTab && (
            <div className='rounded p-2 px-3 flex items-center justify-between gap-2 w-full '>
                ...
                <Link href={`whatsapp://send?text=${shareText}%20${shareLink}`} data-action="share/whatsapp/share" target='_blank'>
                    <FaWhatsapp size={20}/>
                </Link>
                ...
                <Link href={`https://www.facebook.com/sharer/sharer.php?u=${shareLink}&quote=${shareText}`} target='_blank'>
                    <FaFacebook size={20}/>
                </Link>
