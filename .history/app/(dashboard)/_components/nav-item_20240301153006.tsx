...
export const UpdatedNavItems = () => {
  return(
    <div>
      <Link href={`/`} className='rounded p-2 hover:bg-foreground/10 transition flex gap-2 items-center w-full justify-center lg:justify-start text-sm lg:text-base'>
        <Eye size={18}/>
