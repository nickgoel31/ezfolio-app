                ...
                <div>
                    ...
                    <div className='space-y-2 w-full items-center justify-center flex flex-col'>
                        ...
                        <Link href={`/connect`} className='relative group flex items-center gap-3 text-sm font-medium rounded hover:bg-foreground/5 p-2'>
                            <Users size={18}/>
                            <p className='absolute left-0 translate-x-[calc(5vw)] font-medium text-sm p-1 px-2 rounded-md bg-neutral-950 border text-violet-200 group-hover:block hidden animate-fade-in duration-75'>EzConnect</p>
                        </Link>
                        ...
                        <Link href={`/settings/${userId}`} className='relative group flex items-center gap-3 text-sm font-medium rounded hover:bg-foreground/5 p-2'>
                            <Settings2 size={18}/>
                            <p className='absolute left-0 translate-x-[calc(5vw)] font-medium text-sm p-1 px-2 rounded-md bg-neutral-950 border text-violet-200 group-hover:block hidden animate-fade-in duration-75'>Settings</p>
                        </Link>
                        ...
                        <Link href={"https://forms.gle/WMbSaphG1TqQ1krM7"} target='_blank' className='relative group flex items-center gap-3 text-sm font-medium rounded hover:bg-foreground/5 p-2'>
                            <BugIcon size={18}/>
                            <p className='absolute left-0 translate-x-[calc(5vw)] font-medium text-sm p-1 px-2 rounded-md bg-neutral-950 border text-violet-200 group-hover:block hidden animate-fade-in duration-75'>Give Feedback</p>
                        </Link>
