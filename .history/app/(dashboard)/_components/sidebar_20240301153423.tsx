...
export const UpdatedSidebar = ({userId,username}:{userId:string,username:string}) => {
    ...
    return (
        <div className=''>
            <div className='absolute w-full h-full bg-red-500 z-[12]'>

            </div>
            <div onClick={() => setSidebarOpen(!sidebarOpen)} 
            className={cn('cursor-pointer rounded-xl bg-background border p-5 font-semibold text-lg z-[101] fixed top-8 left-12 transition', sidebarOpen && '')}>
