  ...
  return (
    <div className='w-full flex items-center justify-center'>
        <Popover>
            ...
            <PopoverTrigger className='rounded bg-red-500 p-1 lg:hover:bg-foreground/10 transition flex items-center justify-center cursor-pointer z-[10]'>
                <div className='flex items-center text-xs  lg:text-sm font-medium w-full'>
                    <Avatar className=''>
                            <AvatarFallback className='uppercase h-8'>
                                {username.charAt(0)}
                            </AvatarFallback>
                    </Avatar>
                </div>
