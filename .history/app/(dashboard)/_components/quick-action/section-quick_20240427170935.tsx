  ...
  return (
    <div className='py-2 space-y-3'>
        ...
        <div className='grid grid-cols-4 gap-4'>
            ...
            <Link href={`${router.asPath}/info#project-info-dashboard`} className='border shadow-sm rounded-xl items-center space-y-3 p-4 bg-background justify-center flex flex-col font-medium'>
