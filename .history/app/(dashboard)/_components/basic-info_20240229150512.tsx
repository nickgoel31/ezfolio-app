        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
            <div className='border shadow-sm rounded-xl p-5 bg-background w-full space-y-2'>
                ...
                <div className='flex items-center gap-4 justify-between'>
                    {pagePicUrl ? (
                        <div className='border p-1 rounded overflow-hidden object-fill h-full w-full'>
                            <Image src={pagePicUrl} alt='page-pic' width={1000} height={1000} className=''/>
                        </div>
                    ):(
                        <div className='border p-1 rounded overflow-hidden object-fill h-full w-full flex items-center justify-center'>
