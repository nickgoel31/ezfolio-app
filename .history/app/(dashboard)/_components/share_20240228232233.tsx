...
const Share = ({username}:{username:string}) => {
  ...
  return (
    <div className='p-3 px-4 flex flex-col gap-2'>
        ...
        <div onClick={handleCopyToClipboard} className='rounded border bg-foreground/5 p-2 px-3 flex items-center justify-between gap-9 cursor-pointer w-full min-w-[20vw]'>
