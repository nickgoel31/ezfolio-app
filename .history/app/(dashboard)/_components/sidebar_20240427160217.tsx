...
export const NewSidebar = ({userId,username}:{userId:string,username:string}) => {
    return(
        <div className='hidden lg:block fixed px-4 w-[15vw] z-[10] border-r h-full bg-background/30 backdrop-blur-md py-10'>
            <div className='w-full h-full flex flex-col justify-start space-y-'>
                <div className='logo text-2xl w-full px-4 text-center'>
