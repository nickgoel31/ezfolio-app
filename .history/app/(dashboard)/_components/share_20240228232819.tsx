  ...
  return (
    <div className='p-3 px-4 flex flex-col gap-2'>
        ...
        <div className='grid grid-cols-2 gap-2 items-center w-full'>
            <div className='border-b-1 border-primary text-sm font-semibold items-center justify-center w-full text-center pb-1'>
                Link
            </div>

            <div className='border-b border-muted text-sm font-semibold items-center justify-center w-full text-center pb-1'>
                Others
            </div>
        </div>
    </div>
