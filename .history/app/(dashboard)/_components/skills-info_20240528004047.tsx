...
const SkillsInfo = ({skills, userPageId}:{skills:string[],userPageId:string}) => {
    ...
    useEffect(() => {
        setSelectedSkills(prev => [...prev,recentlySelectedSkill])
        setRecentlySelectedSkill()
    },[recentlySelectedSkill])
    ...
    //         setRecentlySelectedSkill(skill)
    //         return;
    //     }
                            ...
                            <Command>
                                ...
                                <CommandList>
                                    ...
                                    {popularSkills.map((pop,index) => (
                                        <div key={index} className='w-full' onClick={() => setRecentlySelectedSkill(pop)}>
                                            <CommandItem  >
                                                {pop}
                                            </CommandItem>
                                        </div>
