        ...
        <div className='space-y-4'>
            <div className='grid grid-cols-1 gap-4  w-full lg:grid-cols-2'>
                ...
                <div className='border shadow-sm rounded-xl p-3 px-5 bg-background w-full space-y-1 relative'>
                    ...
                    <Input className='dark:bg-[#070b17] bg-foreground/5' defaultValue={linkedinUrl || ""} placeholder='https://www.linkedin.com/nickgoel31' type='url' onChange={(e) => setLinkedinUrl(e.target.value)}/>
                </div>
