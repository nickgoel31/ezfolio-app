            ...
            <div className='flex flex-col w-full gap-6'>
                <div className='space-y-2'>
                    ...
                    <div className='w-full relative'>
                        ...
                        <Button size={"sm"} disabled={!isTaglineChanged} onClick={saveTaglineInDataBase} className='absolute top-1/2 -translate-y-1/2 right-2 p-0.5 text-sm font-medium cursor-pointer  px-2'>Save</Button>
                    </div>
                </div>
