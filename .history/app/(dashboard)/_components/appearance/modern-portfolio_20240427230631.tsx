...
const ModernPortfolioToggle = ({userPageId,isAdvancedPortfolioToggled,advancedPortfolioThemes,currentAdvancedPortfolioTheme,currentAdvancedPortfolioThemeColor,tagline}:Props) => {
