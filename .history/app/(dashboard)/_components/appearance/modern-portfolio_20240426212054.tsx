...
const ModernPortfolioToggle = ({userPageId,isAdvancedPortfolioToggled}:Props) => {
    ...
    const [isAdvancedPortfolioToggled, setIsAdvancedPortfolioToggled] = useState(isAdvancedPortfolioToggled)

    const handleToggle = () => {
        updateUserPageAdvancedPortfolioToggleValue(userPageId,!isAdvancedPortfolioToggled)
    }
