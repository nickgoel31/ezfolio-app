...
import { updateColorSchemeOnUserPage } from '@/actions/colorscheme/update-color-scheme'
            ...
            <div className='flex items-center justify-between w-full'>
                <h4 className='text-lg font-medium'>Themes</h4>
                    ...
                    <div className='flex items-center gap-3'>
                        {schemes.length <= 1 &&  (<Button variant={"outline"} onClick={handlePopulateThemes}>Populate Themes</Button>)}
