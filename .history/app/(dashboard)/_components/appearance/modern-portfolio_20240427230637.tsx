...
import { AdvancedPortfolioTheme, AdvancedPortfolioThemeColor, CompatibleThemeWithThemeColor } from '@prisma/client'
...
interface Props{
    ...
    compatibleThemeColorsWithCurrentThemeLayout: CompatibleThemeWithThemeColor[],
    tagline:string | null
}
...
const ModernPortfolioToggle = ({userPageId,isAdvancedPortfolioToggled,advancedPortfolioThemes,currentAdvancedPortfolioTheme,currentAdvancedPortfolioThemeColor,tagline, compatibleThemeColorsWithCurrentThemeLayout}:Props) => {
