...
const AnalyticsBox = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4'>
        ...
        <div className='border shadow-sm rounded-xl p-5 bg-background w-full space-y-3 relative'>
            <div className='absolute w-full h-full flex items-center justify-center top-0 left-0 bg-background/40 backdrop-blur-md rounded-xl z-[2]'>
                <h4 className='font-semibold'>Requests</h4>
                <p className='text-sm font-medium text-'>Coming Soon!</p>
            </div>
            <div className='flex items-center justify-between w-full'>
