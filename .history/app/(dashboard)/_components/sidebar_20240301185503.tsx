                        ...
                        {(
                            <div className={cn('space-y-1 transition-opacity', animation ? "opacity-100 animate-fade-in repeat-1" : "animate-fade-out repeat-1 opacity-0")}>
                                ...
                                <div className='w-full relative group'>
                                    ...
                                    <p className='hidden group-hover:block absolute text-sm font-medium top-1/2 -translate-y-1/2 left-[150%] border border-foreground/10 rounded p-3 bg-background'>{nav.label}</p>
                                </div>
                                ))}
                            </div>
                        )}
