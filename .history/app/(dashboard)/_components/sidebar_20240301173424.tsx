...
export const UpdatedSidebar = ({userId,username}:{userId:string,username:string}) => {
    ...
    return (
        <div className=''>
            ...
            className={cn('updated-sidebar cursor-pointer rounded-xl bg-background border p-5 font-semibold text-lg z-[14] fixed top-8 left-12 transition h-[70px] flex flex-col items-center justify-start', sidebarOpen && 'h-80')}>
