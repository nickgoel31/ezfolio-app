        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
            <div className='border shadow-sm rounded-xl p-5 bg-background w-full space-y-2'>
                ...
                <div className='flex items-center gap-4 justify-between'>
                    {pagePicUrl ? (
                        <Image src={pagePicUrl} alt='page-pic' width={100} height={100} className='rounded-full'/>
                    ):(
                        <div className='w-20 h-20 bg-muted-foreground rounded-full flex items-center justify-center'>
