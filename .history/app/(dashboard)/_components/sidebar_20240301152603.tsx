...
export const UpdatedSidebar = () => {
    ...
    return (
        <div onClick={() => setSidebarOpen(!sidebarOpen)} 
            className={cn('cursor-pointer rounded-xl bg-background border p-5 font-semibold text-lg z-[10] fixed top-8 left-12 right-0 transition', sidebarOpen && 'right-12')}>
            <Logo /> 
        </div>
    )
}