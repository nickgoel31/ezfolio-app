        ...
        <div className='hidden lg:block fixed  w-[5vw] z-[10] border-r h-full bg-background/30 backdrop-blur-md py-10 overflow-hidden'>
            ...
            <div className='w-full h-full flex flex-col justify-between'>
                <div>
                    ...
                    <div className='navlinks bg-red-500 flex flex-col gap-2 mb-6 items-center justify-center w-full'>
                        {navigationItems.map((nav,index) => (
                            <div key={index} className={cn('w-full group flex items-center justify-center')}>
                                <NavItem  nav={nav} userId={userId} username={username}/>
                            </div>
                        ))}
                    </div>
