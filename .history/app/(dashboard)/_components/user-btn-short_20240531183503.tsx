...
const UserButtonShort = ({username,isAdmin}:{username:string,isAdmin?:boolean}) => {
  ...
  return (
    <div className='w-full rounded lg:hover:bg-foreground/10 transition flex items-center justify-center '>
        <Popover>
            
            <PopoverTrigger className=' flex items-center justify-center cursor-pointer z-[10]'>
