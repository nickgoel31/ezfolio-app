...
export const UpdatedSidebar = ({userId,username}:{userId:string,username:string}) => {
    ...
    return (
        <div className='hidden lg:block  w-full'>
            ...
            className={cn('fixed w-full h-full dark:bg-violet-950/10 backdrop-blur-lg z-[99] transition opacity-0', animation ? "opacity-100 animate-fade-in repeat-1" : "animate-fade-out repeat-1 opacity-0")}></div>}
