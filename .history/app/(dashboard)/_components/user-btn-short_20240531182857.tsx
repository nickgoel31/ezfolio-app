...
const UserButtonShort = ({username,isAdmin}:{username:string,isAdmin?:boolean}) => {
  ...
  return (
    <div className='w-full rounded p-1 lg:hover:bg-foreground/10 transition flex items-center justify-center bg-red-500'>
        <Popover>
            <PopoverTrigger className='w-full h-full bg-red-500'>
