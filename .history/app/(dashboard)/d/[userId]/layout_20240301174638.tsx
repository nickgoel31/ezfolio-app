...
const DashboardLayout = async ({params, children}:{children:React.ReactNode, params: {userId:string}}) => {
  ...
  return (
    <body>
        ...
        <div className='pl-0  lg:pb-0 pb-14 min-h-screen bg-gradient-to-tr dark:from-violet-950/20 dark:to-indigo-900/30 from-violet-400/20 to-indigo-400/20 w-full'>
