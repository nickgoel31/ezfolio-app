  ...
  return (
    <body>
        ...
        <div className='pl-0  lg:pb-0 pb-14 min-h-screen  w-full relative'>
          ...
          <div className="block dark:hidden fixed top-0 z-[-2] h-screen w-screen bg-background bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,#2E106520,rgba(255,255,255,0))]"></div>
