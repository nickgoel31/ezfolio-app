...
import { updateUserPageAdvancedPortfolioTheme } from '@/actions/userpage/edit';
...
const AppearancePage = async ({params}:{params:{userId:string}}) => {
  ...
  if(!userPage) {
    ...
    if(!currentAdvancedPortfolioTheme) {
      updateUserPageAdvancedPortfolioTheme(userPage.id,1)
    }
