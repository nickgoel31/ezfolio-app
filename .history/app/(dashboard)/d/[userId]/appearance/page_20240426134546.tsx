  ...
  return (
    <div className=''>
        <div className='flex gap-4'>
          ...
          <div className='flex-[0.8] border shadow-sm rounded-xl p-5 bg-background w-full space-y-2'>
            <iframe src={`https://www.ezfolio.social/${user.username}`} className='border-0 w-full h-full' name="myiFrame" scrolling="no"></iframe>
          </div>
        </div>
    </div>
  )
