    ...
    <div className=''>
        <div className='flex gap-4'>
          <div className='flex-[2] space-y-5'>
            ...
            <ModernPortfolioToggle userPageId={userPage.id} advancedPortfolioThemes={advancedPortfolioThemes} isAdvancedPortfolioToggled={isAdvancedPortfolioToggled} currentAdvancedPortfolioTheme={currentAdvancedPortfolioTheme} currentAdvancedPortfolioTheme={currentAdvancedPortfolioTheme} tagline={userPage.tagline}/>
