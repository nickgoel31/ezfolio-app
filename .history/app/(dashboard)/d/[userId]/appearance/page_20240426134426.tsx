    ...
    <div className=''>
        <div className='flex gap-4'>
          ...
          <div className='flex-[1] border shadow-sm rounded-xl p-5 bg-background w-full space-y-2'>
            <iframe src={`https://www.ezfolio.social/${user}`} className='border-0 ' name="myiFrame" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="400px" width="600px" allowfullscreen></iframe>
          </div>
        </div>
    </div>
  )
