...
const LoadingDashboard = () => {
  return (
    <div className='space-y-5 overflow-hidden relative'>
      <div className='absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-[200] bg-background rounded-lg p-4 border border-violet-500/20'>
        <InfinitySpin color='#8B5CF6' width="200"/>
      </div>
