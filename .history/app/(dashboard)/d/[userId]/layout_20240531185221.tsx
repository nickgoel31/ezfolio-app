...
import {NewSidebar, Sidebar, SidebarV3, UpdatedSidebar} from '../../_components/sidebar';
...
const DashboardLayout = async ({params, children}:{children:React.ReactNode, params: {userId:string}}) => {
  ...
  return (
    <body data-intro="Hello Step one!">
        
            {/* <UpdatedSidebar userId={user.id} username={user.username}/> */}
            {/* <Sidebar userId={user.id} username={user.username}/> */}
            <SidebarV3 userId={user.id} username={user.username} isAdmin={user.isAdmin} />
        ...
        <div className='pl-0  lg:pb-0 pb-14 min-h-screen  w-full relative'>
          ...
          <div className='py-6 lg:py-14 pl-9 pr-9 lg:pl-12 w-full max-w-screen-lg bg-red-500 ml-0 lg:ml-[7vw]'>
