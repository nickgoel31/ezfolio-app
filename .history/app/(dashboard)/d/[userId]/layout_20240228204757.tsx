...
const DashboardLayout = async ({params, children}:{children:React.ReactNode, params: {userDashboardId:string}}) => {

    const {userDashboardId} = params;
  ...
  return (
    <body>
        {/* <div className='z-[10] w-56 hidden lg:block fixed top-0 left-0 h-full border-r bg-background'>
            <Sidebar id={userDB.id} username={userDB.username}/>
        </div>
