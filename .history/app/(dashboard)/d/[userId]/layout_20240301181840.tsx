  ...
  return (
    <body>
      <div className="fixed top-0 z-[-2] h-screen w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
        ...
        <div className='pl-0  lg:pb-0 pb-14 min-h-screen bg-gradient-to-tr dark:from-violet-950/10 dark:to-indigo-950/10 from-violet-400/20 to-indigo-400/20 w-full'>
