                    ...
                    <NavigationMenuList>
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <Link href="/ezbuddy" title="ezbuddy" className='border border-muted-foreground/20 transition-ez p-3 rounded-md font-medium'>
                                    Talk to&nbsp;
                                ...
                                <Link href="/connect" title="Connect" className='border border-muted-foreground/20 transition-ez p-3 rounded-md font-medium'>
                                    EzConnect
                                    <p className='pt-1 font-mute'>
                                        Connect with other developers and designers.
                                    </p>
                                </Link>
                                <Link href="/resume-generator" title="Resume Generator" className='border border-muted-foreground/20 transition-ez p-3 rounded-md font-medium'>
                                    Generate a resume
                                    <p>
