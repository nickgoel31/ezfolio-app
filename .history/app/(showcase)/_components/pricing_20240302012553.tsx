...
const Pricing = () => {
  ...
  return (
    <div id='pricing' className='w-full flex flex-col items-center space-y-7 relative'>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <motion.div key={pricing.id} className={cn('border dark:border-[#131313] rounded-xl w-[23rem] overflow-hidden  bg-gradient-to-t from-violet-800/10 via-transparent to-transparent transition  ', detailedMode && '')}>
                    <div className='rounded-xl shadow-md border dark:border-[#131313]  bg-gradient-to-tr from-[#e7e7fa] to-[#e7e7fa] dark:from-[#0d0d10] dark:to-[#09090b] w-full p-5 px-6 space-y-3'>
