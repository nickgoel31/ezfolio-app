                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem value="item-1" className='!p- w-full'>
                            ...
                            <AccordionContent className='pt-3 w-full'>
                                <Link
                                        className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-violet-200 to-violet-300 dark:from-violet-600 dark:to-violet-900 p-4 no-underline outline-none focus:shadow-md mb-4"
                                        href="/login"
                                    >
