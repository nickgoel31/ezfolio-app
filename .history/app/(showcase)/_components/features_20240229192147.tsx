    ...
    <div className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-xl grid grid-cols-3 gap-4'>
            {featuresList.map((f,index) => (
                <div key={index} className='features-card border flex flex-col rounded-xl border-foreground/10 shadow-sm bg-background p-6 px-6 h-64 hover:border-foreground/80'>
