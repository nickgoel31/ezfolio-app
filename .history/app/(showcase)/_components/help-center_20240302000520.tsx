            ...
            {helpLinks.map((h,index) => {
                ...
                return(
                    <div className='h-full p-[1px] relative rounded-xl overflow-hidden'>
                        <div className='absolute top-0 left-0 w-full h-full bg-red-500 z-[-1]'></div>
                        <Link href={h.url} className='rounded-xl shadow-sm p-6 px-8 space-y-4 flex flex-col h-full items-start justify-between   bg-gradient-to-tr from-[#dfd5ff] to-background cursor-pointer group'>
