            ...
            {helpLinks.map((h,index) => {
                ...
                return(
                    <div className='h-full p-[1px] relative rounded-xl overflow-hidden'>
                        ...
                        <Link href={h.url} className=' shadow-sm rounded-xl p-6 px-8 space-y-4 flex flex-col h-full items-start justify-between   bg-gradient-to-tr from-[#dfd5ff07] cursor-pointer group'>
