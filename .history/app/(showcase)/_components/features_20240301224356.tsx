            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#ffffff07] flex flex-col p-5 px-6 overflow-hidden relative group items-center'>
                    <div className='space-y-2 flex flex-col justify-center h-full'>
                        ...
                        <h1 className='font-semibold text-center  text-4xl leading-snug bg-gradient-to-tr from-[#c7bedf] to-[#beaeeb] bg-clip-text text-transparent'><span className='z-[3]'>Revolutionizing</span> portfolios</h1>
                    </div>
                    <div className='absolute bottom-0 left-1/2 translate-x-[-50%] z-[1] translate-y-[90%]'>
