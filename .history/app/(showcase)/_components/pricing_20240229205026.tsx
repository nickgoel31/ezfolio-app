  ...
  return (
    <div className='w-full flex flex-col items-center space-y-7 relative'>
        <div className='absolute top-5 right-5'>
            <Button onClick={toggleDetailedMode} className='bg-gradient-to-t from-neutral-800 via-neutral-800 to-neutral-700 text-white'>{detailedMode ? 'Hide Details' : 'Show Details'}</Button>
        </div>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <div key={pricing.id} className='border rounded-xl w-[23rem]'>
