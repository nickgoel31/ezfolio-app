...
export const FeatureCard1 = () => {
    return (
        <div className='border w-[390px]   transition h-[60px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#0d0b10] overflow-hidden py-6 px-8'>
