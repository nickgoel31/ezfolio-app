...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border w-[300px] -rotate-3 -translate-x-8 h-[400px] z-[1] rounded-xl border-foreground/10 shadow-xl bg-gradient-to-bl from-[#73a88f50] via-[#6ca0a550] to-[#7694a350] overflow-hidden py-6 px-8'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
                                        <div className='h-8 w-8 rounded-full bg-teal-100/30 text-teal-950 border border-foreground/5 flex items-center justify-center text-[0.55rem] font-semibold text-muted-foreground'>H</div>
                                        <div className='text-center'>
                                            <h5 className='text-[0.55rem] font-semibold'>Harsh Goel</h5>
                                            <p className='text-[0.35rem] text-muted-foreground'>@harshgoel</p>
                                        </div>
