...
export const AppearanceShowcaseCard2 = () => {
    return (
        <div className='border w-[290px]  group-hover:animate-revolutionize-card transition h-[340px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#e4e4e4] dark:to-[#0d0b10] overflow-hidden py-6 px-8'>
                                <div className='w-full h-full flex flex-col items-center space-y-2 opacity-50 dark:opacity-30'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
                                        <div className='h-8 w-8 rounded-full bg-background/40 border border-foreground/5 flex items-center justify-center text-[0.55rem] font-semibold text-muted-foreground'>H</div>
                                        <div className='text-center'>
                                            <h5 className='text-[0.55rem] font-semibold'>Harsh Goel</h5>
...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border blur-[0.5px] w-[300px] h-[400px] z-[1] rounded-xl dark:border-foreground/10 shadow-xl bg-gradient-to-r dark:from-[#8a75c3] from-[#e9e1ff] to-[#b59cf9] dark:to-[#7657cb] overflow-hidden py-6 px-8 group-hover:animate-changing-color-light dark:group-hover:animate-changing-color'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
...
export const FeatureCard1 = () => {
    return (
        <div className='feature-showcase-feature-section-card-1 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Projects</h1>
...
export const FeatureCard2 = () => {
    return (
        <div className='feature-showcase-feature-section-card-2 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Experience</h1>
...
export const FeatureCard3 = () => {
    return (
        <div className='feature-showcase-feature-section-card-3 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Skills</h1>
