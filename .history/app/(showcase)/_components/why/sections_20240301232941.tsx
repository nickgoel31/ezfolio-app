...
export const FeatureCard3 = () => {
    return (
        <div className='feature-showcase-feature-section-card-3 border w-[280px] transition h-[50px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#0d0b10] overflow-hidden'>
