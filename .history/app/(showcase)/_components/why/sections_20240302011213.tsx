...
export const AppearanceShowcaseCard1 = () => {
    return (
        <div className='border w-[300px] z-[3] h-[400px] rotate-2 -translate-y-3 rounded-xl border-foreground/10 shadow-xl bg-gradient-to-tr dark:from-[#110f26] from-[#d6d3f1] dark:to-[#0e0d12] overflow-hidden py-6 px-8'>
