...
export const FeatureCard1 = () => {
    return (
        <div className='feature-showcase-feature-section-card-1 border w-[280px] transition h-[30px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#0d0b10] overflow-hidden py-6 px-8'>
