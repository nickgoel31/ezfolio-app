...
export const FeatureCard3 = () => {
    return (
        <div className='feature-showcase-feature-section-card-3 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Skills</h1>
