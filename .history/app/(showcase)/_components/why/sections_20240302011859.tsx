...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border blur-[0.5px] w-[300px] h-[400px] z-[1] rounded-xl border-foreground/10 shadow-xl bg-gradient-to-r dark:from-[#8a75c3] from-[#b4a0ec] to-[#b59cf9] dark:to-[#7657cb] overflow-hidden py-6 px-8 group-hover:animate-changing-color-light dark:group-hover:animate-changing-color'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
