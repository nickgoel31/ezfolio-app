...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border w-[300px] h-[400px] z-[1] rounded-xl border-foreground/10 shadow-xl bg-gradient-to-r from-[#947ed360] to-[#7f5edb60] overflow-hidden py-6 px-8 group-hover:animate-changing-color'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
