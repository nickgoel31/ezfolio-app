...
export const AppearanceShowcaseCard2 = () => {
    return (
        <div className='border w-[130px] group-hover:w-[260px] group-hover:h-[320px] transition   z-[3] h-[180px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr overflow-hidden py-2 px-2'>
