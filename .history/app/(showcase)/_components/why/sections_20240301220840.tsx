...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border w-[300px] h-[400px] z-[1] rounded-xl border-foreground/10 shadow-xl bg-gradient-to-r from-[#9e8bd2] to-[#7f5edb] overflow-hidden py-6 px-8 group-hover:animate-changing-color'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
