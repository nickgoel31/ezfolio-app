...
export const FeatureCard1 = () => {
    return (
        <div className='feature-showcase-feature-section-card-1 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Projects</h1>
...
export const FeatureCard2 = () => {
    return (
        <div className='feature-showcase-feature-section-card-2 border w-[280px] transition h-[40px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background dark:to-[#0d0b10] overflow-hidden text-xs font-medium text-muted-foreground flex items-center justify-between px-4'>
            <h1>Experience</h1>
