...
export const CreateAccountSection = () => {
  return (
    <div className='w-full flex h-full gap-5'>
                        <div className='space-y-2 w-full flex-[1.5]'>
                        ...
                        <div className='w-full flex-[0.5] h-full flex items-center justify-center p-10 rounded-xl overflow-hidden object-fill'>
...
export const ShowcaseWorkSection = () => {
    return (
        <div className='w-full flex h-full gap-5'>
                        ...
                        <div className='space-y-2 w-1/2 flex flex-col items-center justify-center h-full text-center'>
