...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border w-[300px] absolute -rotate-3 -translate-x-8 h-[400px] z-[2] rounded-xl border-foreground/10 shadow-md bg-gradient-to-bl from-[#73a88f] via-[#6ca0a5] to-[#7694a3] overflow-hidden py-6 px-8'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
                                        <div className='h-8 w-8 rounded-full bg-neutral-300 border border-foreground/5 flex items-center justify-center text-[0.55rem] font-semibold text-muted-foreground'>H</div>
                                        <div className='text-center'>
                                            <h5 className='text-[0.55rem] font-semibold'>Harsh Goel</h5>
                                            <p className='text-[0.35rem] text-muted-foreground'>@harshgoel</p>
                                        </div>
