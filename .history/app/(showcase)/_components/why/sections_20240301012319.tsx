...
export const AppearanceSection = () => {
    return (
        <div className='w-full flex flex-col md:flex-row items-center justify-center md:items-start md:justify-start h-full gap-5'>
                        ...
                        <div className='w-full flex-[1]  flex items-center justify-center p-10 rounded-xl overflow-hidden object-fill'>
                            <div className='border w-[350px] h-[400px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-violet-950/40 overflow-hidden py-6 px-16'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    ...
                                    <div className='grid grid-cols-3 w-full items-center gap-3'>
                                        <div className='bg-background/40 border border-foreground/5 rounded flex flex-col p-1.5 items-center justify-center text-[0.35rem] text-muted-foreground font-medium space-y-1 outline outline-[0.5px] outline-offset-1 outline-foreground/10'>
                                            <FolderKanban size={8}/>
                                            <p>Projects</p>
                                        </div>
