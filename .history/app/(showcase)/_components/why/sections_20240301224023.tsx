...
export const AppearanceShowcaseCard2 = () => {
    return (
        <div className='border w-[300px]   z-[3] h-[400px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#120a22] overflow-hidden py-6 px-8'>
