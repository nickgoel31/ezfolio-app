...
export const AppearanceShowcaseCard1 = () => {
    return (
        <div className='border w-[300px] absolute h-[400px] -translate-y-3 rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-violet-950/40 overflow-hidden py-6 px-8'>
