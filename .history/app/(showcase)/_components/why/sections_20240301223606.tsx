...
export const AppearanceShowcaseCard2 = () => {
    return (
        <div className='border w-[290px]  z-[3] h-[280px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-background to-[#120a22] overflow-hidden py-2 px-2'>
