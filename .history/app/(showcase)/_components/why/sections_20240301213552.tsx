...
export const AppearanceShowcaseCard3 = () => {
    return (
        <div className='border w-[300px] -rotate-3 -translate-x-8 h-[400px] z-[2] rounded-xl border-foreground/10 shadow-xl bg-gradient-to-bl from-[#73a88f] via-[#6ca0a5] to-[#7694a3] overflow-hidden py-6 px-8'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    <div className='space-y-1.5 w-full flex flex-col items-center justify-center'>
