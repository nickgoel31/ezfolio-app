                            ...
                            <div className='border w-[350px] h-[400px] rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-violet-950/40 overflow-hidden py-6 px-12'>
                                <div className='w-full h-full flex flex-col items-center space-y-2'>
                                    ...
                                    <div className='w-full flex flex-col gap-1.5'>
                                        <div className='bg-background/40 border border-foreground/5 rounded flex p-1 items-center justify-center text-[0.35rem] text-muted-foreground font-medium space-y-1'>
                                            <Hand size={8}/>
                                            <p>Skills</p>
                                        </div>
                                    </div>
