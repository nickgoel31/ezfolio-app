...
import { AppearanceShowcaseCard1, AppearanceShowcaseCard2, AppearanceShowcaseCard3 } from './why/sections'
    ...
    <div id='features' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-lg flex flex-col gap-4'>
            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden relative'>
                    <div className='space-y-2'>
                        <p className=' font-medium text-muted-foreground'>Tell your story</p>
                        ...
                        <div className=' absolute translate-y-8 z-[2]'>
                            <AppearanceShowcaseCard1 />
                        </div>
                        <div className=' absolute translate-y-8 right-0 z-[1]'>
                            <AppearanceShowcaseCard3 />
                        </div>
                    </div>
                    
                </div>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#ffffff07]'>

                </div>
            </div>
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-foreground/5 bg-gradient-to-tr from-[#ffffff07]'>

                </div>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-foreground/5 bg-gradient-to-tr from-[#ffffff07]'>
