    ...
    <div id='features' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-lg flex flex-col gap-4'>
            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                ...
                <div className='flex-[1] w-full h-80 rounded-3xl border border-[#131313] bg-neutral-50 dark:bg-neutral-950'>

                </div>
            </div>
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-foreground/5 bg-neutral-50 dark:bg-neutral-950'>

                </div>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-foreground/5 bg-neutral-50 dark:bg-neutral-950'>
