    ...
    <div id='features' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-lg flex flex-col gap-4'>
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border dark:border-[#131313] bg-gradient-to-tr from-[#2c2a3307] dark:from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden relative group backdrop-blur-sm'>
