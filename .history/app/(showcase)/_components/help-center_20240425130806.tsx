...
const HelpCenter = () => {
  return (
    <div id='help' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-screen-lg w-full items-center gap-6 px-10 lg:px-0'>
            {helpLinks.map((h,index) => {
                const Icon:LucideIcon | IconType = h.icon;
                return(
                    <div key={index} className='h-[260px] p-[1px] relative rounded-xl  group'>
                        {/* BORDER */}
