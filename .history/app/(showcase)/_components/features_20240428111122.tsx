    ...
    <div id='features' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-lg flex flex-col gap-4 px-8 h-full'>
            ...
            <div className='flex lg:hidden w-full flex-row gap-4 h-full'>
                ...
                <div className='flex-[1] w-full h-[350px] rounded-3xl border dark:border-[#131313] bg-gradient-to-tr from-[#34313d13] dark:from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden relative group items-center backdrop-blur-sm'>
                        <div className=' flex flex-col justify-center h-full'>
                            <p className='absolute top-5 left-6 font-medium text-sm text-muted-foreground'>Innovation</p>
