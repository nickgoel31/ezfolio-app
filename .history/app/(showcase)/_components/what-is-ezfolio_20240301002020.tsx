                    ...
                    <div className='w-full flex h-full gap-5'>
                        ...
                        <div className='w-1/2 h-full flex items-center justify-center p-10 rounded-xl overflow-hidden object-fill'>
                            <div className='border w-[300px] h-full rounded-xl border-foreground/10 shadow-md bg-gradient-to-tr from-violet-950/40 overflow-hidden'>
                                <div className='w-full h-full p-4 px-7 flex flex-col space-y-3 text-muted-foreground'>
                                    <div className='space-y-1'>
                                        <p className='text-[0.55rem] font-medium'>Email</p>
                                        <Input className='w-full h-8 text-[0.55rem] bg-background/40 border border-foreground/5' value={"harshgoel2004@gmail.com"}/>
                                    </div>
                                    <div className='space-y-1'>
                                        <p className='text-[0.55rem] font-medium'>Username</p>
                                        <Input className='w-full h-8 text-[0.55rem] bg-background/40 border border-foreground/5' value={"harshgoel"}/>
                                    </div>
                                    <div className='space-y-1'>
                                        <p className='text-[0.55rem] font-medium'>Name</p>
                                        <Input className='w-full h-8 text-[0.55rem] bg-background/40 border border-foreground/5' value={"harshgoel2004@gmail.com"}/>
                                    </div>
                                </div>  
                            </div>
