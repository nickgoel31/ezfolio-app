    ...
    <div id='pricing' className='w-full flex flex-col items-center space-y-7 relative'>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <motion.div key={pricing.id} className={cn('border border-[#131313] rounded-xl w-[23rem] overflow-hidden  bg-gradient-to-t from-violet-800/10 via-transparent to-transparent transition h-[228px] ', detailedMode && 'h-[560px]')}>
                    <div className='rounded-xl shadow-md border border-[#131313]  bg-gradient-to-tr from-[#0d0d10] to-[#09090b] w-full p-5 px-6 space-y-3'>
