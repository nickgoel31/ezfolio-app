                        ...
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <li className="row-span-3">
                                    ...
                                    <a
                                        className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-violet-600 to-violet-900 p-6 no-underline outline-none focus:shadow-md"
                                        href="/connect"
                                    >
