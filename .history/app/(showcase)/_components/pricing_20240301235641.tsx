    ...
    <div className='w-full flex flex-col items-center space-y-7 relative'>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <motion.div key={pricing.id} className={cn('border border-[#484848] rounded-xl w-[23rem] overflow-hidden  bg-gradient-to-t from-violet-800/10 via-transparent to-transparent transition h-[218px] ', detailedMode && 'h-[560px]')}>
                    <div className='rounded-xl shadow-md border  bg-gradient-to-tr from-[#dfd5ff07] w-full p-5 px-6 space-y-3'>
