                    ...
                    <NavigationMenuList>
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <Link href="/ezbuddy" title="ezbuddy" className=' transition-ez p-2 bg-accent/60 rounded-md font-medium'>
                                ...
                                <Link href="/connect" title="Connect" className='transition-ez p-2 hover:bg- rounded-md font-medium'>
                                    EzConnect
                                    <p className='pt-1 text-sm text-muted-foreground'>
                                        Connect with other developers and designers.
                                    </p>
                                </Link>
                                <Link href="/resume-generator" title="Resume Generator" className=' transition-ez p-2 rounded-md font-medium'>
                                    Generate a resume
                                    <p className='pt-1 text-sm text-muted-foreground'>
