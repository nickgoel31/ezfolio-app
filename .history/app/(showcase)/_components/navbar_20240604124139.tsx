                        ...
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <Link href="/docs" title="Introduction" className='border border-muted-foreground/0 hover:border-muted-foreground/20 transition-ez p-3 rounded-md'>
                                    <p className='ai-chatbot-gradient-text bg-gradient-to-tr from-teal-200 via-indigo-200 to-rose-200 bg-clip-text text-transparent font-bold text-lg'>EzBuddy</p>
                                </Link>
