    ...
    <div id='features' className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='w-full max-w-screen-lg flex flex-col gap-4'>
            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden'>
                    <div className='space-y-2'>
                        <p className=' font-medium text-muted-foreground'>Tell your story</p>
                        <h1 className='font-bold text-3xl leading-snug bg-gradient-to-tr from-[#c7bedf] to-[#beaeeb] bg-clip-text text-transparent'>Captivate with simplistic portfolio but packed with details</h1>
                    </div>
                </div>
