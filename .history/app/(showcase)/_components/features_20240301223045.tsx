            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#ffffff07] flex flex-col p-5 px-6 overflow-hidden relative group items-center'>
                    <div className='space-y-2 flex flex-col justify-center h-full'>
                        <p className='absolute top-5 left-6 font-medium text-sm text-muted-foreground'>Customizable</p>
                        <h1 className='font-semibold text-center  text-4xl leading-snug bg-gradient-to-tr from-[#c7bedf] to-[#beaeeb] bg-clip-text text-transparent'>Revolutionizing portfolios</h1>
                        <div className=' absolute -translate-y-1/2 top-1/2 z-[-1] left-1/2  -translate-x-1/2 group-hover:translate-y-6 transition duration-700'>
