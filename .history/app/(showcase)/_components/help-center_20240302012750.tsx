            ...
            {helpLinks.map((h,index) => {
                ...
                return(
                    <div className='h-[260px] p-[1px] relative rounded-xl overflow-hidden group'>
                        ...
                        {/* MAIN CONTENT */}
                        <Link href={h.url} className='rounded-xl shadow-sm p-6 px-8 space-y-4 flex flex-col h-full items-start justify-between   bg-gradient-to-tr from-[#f2f2f3] to-[#fefeff] dark:from-[#0d0d10] dark:to-[#09090b] cursor-pointer group'>
