...
import { AppearanceSection, CreateAccountSection,  ShowcaseWorkSection } from './why/sections'
  ...
  return (
    <div className='flex w-full flex-col items-center space-y-7'>
        ...
        <div className='flex flex-col w-full max-w-screen-lg relative items-start justify-start space-y-8'>
            ...
            <div className='w-full gap-7 flex flex-col  relative'>
                <div className='w-full  p-7 px-9'>
                    {isFirstSection && <CreateAccountSection />}

                    {isSecondSection && <AppearanceSection /> }

                    {isThirdSection && <ShowcaseWorkSection />}
                </div>
            </div>
        </div>
    </div>
