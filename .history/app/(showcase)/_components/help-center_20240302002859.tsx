                ...
                return(
                    <div className='h-[260px] p-[1px] relative rounded-xl overflow-hidden group'>
                        ...
                        <div className='absolute top-0 left-0 w-full h-full bg-[#131313] z-[-1]'>
                            <div className='group-hover:opacity-100 opacity-0 help-center-card-border absolute w-[200%] h-[200%] bg-gradient-to-tr from-transparent via-transparent to-foreground/20 top-[-50%] left-[-50%] transition-scroll-nav delay-100'>
