            ...
            <div className='w-full gap-7 flex  relative'>
                <div className='w-full border border-foreground/10 rounded-xl bg-gradient-to-tr h-[70vh] from-violet-950/40 p-7 px-7'>
                    <div className='w-full flex h-full gap-5'>
                        ...
                        <div className='w-1/2 h-full flex items-center justify-center p-10 border rounded-xl overflow-hidden object-fill'>
                            <div className='border w-[300px] h-full rounded-full border-foreground/10 shadow-md bg-gradient-to-tr from-violet-950/40'>
