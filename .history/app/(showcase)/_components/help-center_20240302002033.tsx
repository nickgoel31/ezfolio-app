    ...
    <div className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-screen-lg w-full items-center gap-6'>
            {helpLinks.map((h,index) => {
                ...
                return(
                    <div className='h-[300px] p-[1px] relative rounded-xl overflow-hidden'>
                        {/* BORDER */}
                        <div className='absolute top-0 left-0 w-full h-full bg-[#131313] z-[-1]'>
                            <div className='help-center-card-border absolute bottom-[0%] right-[0%] bg-foreground/10 w-14 h-14'>
