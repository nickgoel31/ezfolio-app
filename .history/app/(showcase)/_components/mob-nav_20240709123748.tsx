                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem value="item-1" className='!p- w-full'>
                            ...
                            <AccordionContent className='pt-3 w-full'>
                                <Link
                                        className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-violet-200 to-violet-300 dark:from-violet-600 dark:to-violet-900 p-5 no-underline outline-none focus:shadow-md mb-4"
                                        href="/login"
                                    >
                                ...
                                <Link href="/ezbuddy" title="ezbuddy" className='relative transition-ez p-2 flex items-center justify-between rounded-md font-medium w-full'>
                                    ...
                                    <p className='rounded-md bg-violet-300 text-xs text-violet-800 p-0.5 px-1.5'>New</p>
                                </Link>

                                <Link href="/connect" title="ezconnect" className='relative transition-ez p-2 flex items-center justify-between rounded-md font-medium w-full'>
                                    EzConnect
                                </Link>
                                <Link href="/resume-generator" title="ezresume-gen" className='relative transition-ez p-2 flex items-center justify-between rounded-md font-medium w-full'>
                                    Generate a resume
                                </Link>
                            </AccordionContent>
                        </AccordionItem>
