    ...
    <div className='w-full flex flex-col items-center space-y-7 relative'>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <motion.div key={pricing.id} className={cn('border rounded-xl w-[23rem] overflow-hidden  bg-gradient-to-t from-neutral-800/50 via-transparent to-transparent transition h-[218px]', detailedMode && 'h-[505px]')}>
