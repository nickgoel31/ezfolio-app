                        ...
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <li className="row-span-3">
                                    ...
                                    <a
                                        className="flex h-full w-full select-none flex-col justify-start rounded-md bg-gradient-to-b from-violet-500/50 to-purple-400/50 p-6 no-underline outline-none focus:shadow-md"
                                        href="/connect"
                                    >
                                ...
                                <Link href="/docs" title="Introduction" className='border border-muted-foreground/0 hover:border-muted-foreground/20 transition-ez p-3 rounded-md'>
