    ...
    <div className='w-full flex flex-col items-center space-y-7'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-screen-lg w-full items-center gap-6'>
            <div className='border shadow-sm rounded-xl p-4'>
                ...
                <p>Documents describe how things should be done. They have a version history and they require a proper review process when updated. Records on the other hand show how things were done. They are proof of activities performed </p>
            </div>
        </div>
    </div>
  )
