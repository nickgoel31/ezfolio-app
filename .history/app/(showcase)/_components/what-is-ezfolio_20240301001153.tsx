    ...
    <div className='hidden lg:flex w-full flex-col items-center space-y-7'>
        ...
        <div className='flex flex-col w-full max-w-screen-lg relative items-start justify-start space-y-8'>
            ...
            <div className='w-full gap-7 flex  relative'>
                <div className='w-full border border-foreground/10 rounded-xl bg-gradient-to-tr h-[100vh] from-violet-950/40 p-7 px-7'>
                    <div className='w-full flex h-full space-y-5'>
                        <div className='w-full h-full  rounded-xl overflow-hidden object-contain'>
                            <Image src={"/harsh-goel.jpg"} alt='Harsh Goel' className='object-center' width={1000} height={1000} />
                        </div>
