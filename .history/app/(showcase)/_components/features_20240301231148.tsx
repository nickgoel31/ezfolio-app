            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#ffffff07] flex flex-col p-5 px-6 overflow-hidden relative group items-center'>
                    <div className=' flex flex-col justify-center h-full'>
                        ...
                        <span className='z-[3] font-semibold text-center  text-4xl leading-snug bg-gradient-to-tr from-[#c7bedf] to-[#beaeeb] bg-clip-text text-transparent'>Revolutionizing</span>
                        <span className='z-[3] font-semibold text-center  text-4xl leading-snug bg-gradient-to-tr from-[#c7bedf] to-[#beaeeb] bg-clip-text text-transparent'>portfolios</span>
                    </div>
