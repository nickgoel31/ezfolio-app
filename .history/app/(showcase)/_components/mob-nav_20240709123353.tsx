                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem value="item-1" className='!p- w-full'>
                            ...
                            <AccordionContent className='pt-3 w-full'>
                                <Link href="/ezbuddy" title="ezbuddy" className='relative transition-ez p-2 flex items-center jus rounded-md font-medium w-full'>
                                    ...
                                    <p className='rounded-md bg-violet-300 text-xs text-violet-800'>New</p>
                                </Link>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
