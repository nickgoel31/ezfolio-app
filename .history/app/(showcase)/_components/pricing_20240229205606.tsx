    ...
    <div className='w-full flex flex-col items-center space-y-7 relative'>
        ...
        <div className='flex flex-col lg:flex-row flex-wrap gap-8'>
            {pricingList.map((pricing) => (
                <div key={pricing.id} className='border rounded-xl w-[23rem] overflow-hidden h-[500px]'>
                    ...
                    {detailedMode && (
                        <div className='bg-gradient-to-t from-neutral-800/50 to-transparent p-4 h-full'>
                            <ul>
