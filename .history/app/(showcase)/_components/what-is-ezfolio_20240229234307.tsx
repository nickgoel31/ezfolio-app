...
const WhatIsApp = () => {
  return (
    <div className='hidden lg:flex w-full flex-col items-center space-y-7'>
        ...
        <div className='flex flex-col w-full max-w-screen-lg h-[200vh] relative items-start justify-start'>
            ...
            <div className='w-full flex items-center relative'>
                ...
                <div className='border rounded-xl bg-gradient-to-tr from-violet-950/40 w-1/2 p-5 px-6 sticky top-[var(--navbar-height)]'>
