            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden relative group'>
                    <div className='space-y-2'>
                        ...
                        <div className=' absolute translate-y-8 z-[2] group-hover:-translate-y-6 transition duration-700'>
                            <AppearanceShowcaseCard1 />
                        </div>
                        <div className=' absolute translate-y-8 right-0 z-[1] group-hover:-translate-y-0 transition duration-700 delay-100'>
