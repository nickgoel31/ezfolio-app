    ...
    <div className='hidden lg:flex w-full flex-col items-center space-y-7'>
        ...
        <div className='flex flex-col w-full max-w-screen-lg relative items-start justify-start space-y-8'>
            ...
            <div className='w-full gap-7 flex  relative'>
                <div className='w-full border border-foreground/5 rounded-xl bg-gradient-to-tr h-[70vh] from-violet-950/40 p-7 px-7'>
                    <div className='w-full flex flex-col h-full space-y-5'>
                        <div className='w-full h-full border border-foreground/5 rounded-xl'>
