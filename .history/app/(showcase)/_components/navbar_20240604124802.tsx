                    ...
                    <NavigationMenuList>
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                ...
                                <Link href="/ezbuddy" title="ezbuddy" className=' transition-ez p-2 hover:bg-accent/50 rounded-md font-medium'>
                                ...
                                <Link href="/connect" title="Connect" className='transition-ez p-2 rounded-md font-medium'>
                                    EzConnect
                                    <p className='pt-1 text-sm text-muted-foreground'>
