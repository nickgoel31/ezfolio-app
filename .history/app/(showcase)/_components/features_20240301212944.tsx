            ...
            <div className='w-full flex flex-col md:flex-row gap-4'>
                <div className='flex-[1.7] w-full h-80 rounded-3xl border border-[#131313] bg-gradient-to-tr from-[#dfd5ff07] flex flex-col p-5 px-6 overflow-hidden'>
                    <div className='space-y-2'>
                        <p className=' font-medium'>Tell your story</p>
                        <h1 className='font-semibold text-3xl leading-snug text-[#b7afce]'>Captivate with simplistic portfolio but packed with details</h1>
                    </div>
                </div>
