    ...
    <div className='w-full h-full flex items-center justify-center'>
        <div className='rounded-full border border-foreground/10 bg-background/20 backdrop-blur-lg shadow-sm p-3 w-full max-w-screen-md flex items-center justify-between px-6'>
            ...
            <div className='flex items-center gap-3'>    
                ...
                <Link href={"/login"} className='p-2 px-4 rounded-full text-xs font-medium bg-gradient-to-t from-violet-300/60 dark:from-violet-950 hover:border-opacity-100 border border-opacity-0'>
                    Get started
                </Link>
            </div>
        </div>
