...
const AITest = () => {
  ...
  const [messages,setMessages] = useState<HistoryMessage[]>(localStorageMessages)
  const [localStorageMessages, setLocalStorageMessages] = useLocalStorage<HistoryMessage[]>("messages",messages)
  ...
  return (
    <div className='relative w-full h-screen overflow-x-hidden mx-auto py-10 px-2 pb-32'>
      ...
      {localStorageMessages.length === 0 && <div className='w-full h-full flex flex-col items-center justify-between max-w-screen-sm mx-auto space-y-6'>
