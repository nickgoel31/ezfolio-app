...
const AITest = () => {
  ...
  return (
    <div className='relative w-full  h-screen overflow-x-hidden mx-auto  px-2 pb-32'>
      ...
      <div className="fixed bottom-0 right-[-20%] top-[-10%] h-[500px] z-[-100] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,#FECDD315,rgba(255,255,255,0))]"></div>
      <div className="fixed bottom-[10%] left-1/2 -translate-x-1/2 h-[500px] w-[500px] z-[-100] rounded-full bg-[radial-gradient(circle_farthest-side,#4F46E515,rgba(255,255,255,0))]"></div>
