    ...
    <div className='relative w-full min-h-screen h-[300vh] overflow-x-hidden mx-auto py-10 px-2 pb-32'>
      ...
      <div className='w-full max-w-screen-sm mx-auto space-y-6'>
        <div className='flex flex-col gap-4 items-center'>
          <div className='border rounded-lg p-3 bg-foreground/10 bg-gradient-to-tr from-teal-200 via-indigo-200 to-rose-200 bg-clip-text text-transparent'>
            <MessagesSquareIcon size={21}/>
          </div>
