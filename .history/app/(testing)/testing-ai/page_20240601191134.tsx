...
const AITest = () => {
  ...
  return (
    <div className='relative w-full bg-red-600 h-screen overflow-x-hidden mx-auto py-10 px-2 pb-32'>
      ...
      {messages.length > 0 && (
        <div className='sticky top-0 w-full max-w-screen-sm mx-auto py-8 bg-red-500'>
