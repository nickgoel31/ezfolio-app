  ...
  return (
    <div className='relative w-full min-h-screen h-[300vh] overflow-x-hidden mx-auto py-10 px-2 pb-32'>
      ...
      <div className='w-full max-w-screen-sm mx-auto'>
        <h1 className='font-semibold text-6xl leading-normal font-poppins text-center'>Hi, I'm <span className='bg-gradient-to-tr from-teal-200 via-indigo-200 to-rose-200 '>EzBuddy</span></h1>
      </div>
