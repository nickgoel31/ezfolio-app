...
import { Code2, MessagesSquareIcon } from 'lucide-react'
    ...
    <div className='relative w-full h-screen overflow-x-hidden mx-auto py-10 px-2 pb-32'>
      ...
      <div className='w-full h-full flex flex-col items-center justify-between max-w-screen-sm mx-auto space-y-6'>
        ...
        <div className='pb-8 flex flex-wrap gap-4'>
          <div className='bg-foreground/[0.02] backdrop-blur-md p-4 border rounded-lg text-muted-foreground space-y-2'>
