                ...
                <>
                    ...
                    {projects.map((project,index) => (
                        <View key={index} style={{marginBottom:8}}>
                            <View style={styles.flexDiv}>
                                <Text style={styles.headingFour}>{project.title}</Text>
                            </View>
                            <Text style={styles.paragraph}>{project.description}</Text>
                            <View style={styles.flexDiv}>
                                <Link src={project.deployUrl} style={styles.paragraph}>Visit</Link>
                                <Link href='' src={project.githubUrl} style={styles.paragraph}>Github</Link>
                            </View>
                        </View>
                    ))}
                </>
