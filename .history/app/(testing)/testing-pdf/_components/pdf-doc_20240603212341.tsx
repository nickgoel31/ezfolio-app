    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.flexDiv}>
        <View style={styles.flexContainerMinority}>
            <Text style={styles.headingTwo}>SKILLS</Text>
        </View>
        <View style={styles.section}>
            <Svg width={"100%"} height={"100%"} style={{backgroundColor: "gray", marginTop: 20, marginBottom: 20, opacity:0.5}}/>
        </View>
        <View style={styles.flexContainerMajority}>
            <Text style={styles.headingTwo}>EDUCATION</Text>
        </View>
      </View>
    </Page>
  </Document>
