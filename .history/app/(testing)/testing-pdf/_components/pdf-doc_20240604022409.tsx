...
import { ExperienceResume, SkillResume } from '@/app/(dashboard)/resume-generator/_components/nsiu-resume-form';
...
export const MyDocumentUNSI = ({skills, experiences, projects,awards,education}:{skills: SkillResume[], experiences:ExperienceResume[], projects:Project[], <education:EducationResume></education:EducationResume>[]}) => (
<Document creator='Ezfolio' producer='Ezfolio' title={`${userPage.title}'s Resume`} subject={`Created with Ezfolio`}>
    <Page size="A4" style={styles.page} wrap={false}>
      <View style={styles.flexDiv}>
        <View>
