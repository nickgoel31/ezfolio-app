...
import { Education, Experience, Project, UserPage } from '@prisma/client';
...
export const MyDocument = ({userPage, experiences, projects,awards,education}:{userPage:UserPage, experiences:Experience[], projects:Project[], education:Education[],awards:}) =>(
