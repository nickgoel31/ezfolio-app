...
import { Experience, Project, UserPage } from '@prisma/client';
...
export const MyDocument = ({userPage, experiences, projects}:{userPage:UserPage, experiences:Experience[], projects:Project[]}) =>(
            ...
            {projects.length > 0 && (
                <View>
                    ...
                    {projects.map((project) => (
                        <View key={project.id}>
                            <Text style={styles.headingThree}>{project.projectTitle}</Text>
                            <Text style={styles.listItem}>{project.projectDesc}</Text>
                            {project.projectUrl.length > 0 && <Link href={project.projectUrl}>Watch it live here!</Link>}
                        </View>
                    ))}
                </View>
            )}
