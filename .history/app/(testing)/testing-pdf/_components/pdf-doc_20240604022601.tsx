...
export const MyDocumentUNSI = ({values,profilePic,skills, experiences,education}:{values: z.infer<typeof resumeSchema>,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[]}) => (
