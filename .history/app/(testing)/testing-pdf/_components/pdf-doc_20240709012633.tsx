...
export const MyDocumentUNSI = ({values,profilePicUrl,skills, experiences,education, awards, certification}:{values: z.infer<typeof resumeSchema>,profilePicUrl:string,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[]}) => (
