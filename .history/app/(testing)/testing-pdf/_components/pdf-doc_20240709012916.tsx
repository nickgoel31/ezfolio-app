...
import { AwardResume, CertificationResume, EducationResume, ExperienceResume, SkillResume, UserPageType } from '@/types';
import { z } from 'zod';
...
export const MyDocumentUNSI = ({values,profilePicUrl,skills, experiences,education, awards, certifications}:{values: z.infer<typeof resumeSchema>,profilePicUrl:string,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[], awards: AwardResume[], certifications: CertificationResume[]}) => (
                    ...
                    {experiences.map((exp,index) => (
                        ...
                        <View style={{marginBottom:8}}>
                            <View style={styles.flexDiv}>
                                ...
                                <Text style={styles.date}>{exp?.startDate?.getFullYear()} - {edu.endDate?.getFullYear() || "Present"}</Text>
                            </View>
                            <Text style={styles.listItem}>Netedge India</Text>
                            <Text style={styles.paragraph}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur veniam a adipisci neque reprehenderit amet.</Text>
                        </View>
