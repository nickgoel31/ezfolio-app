            ...
            {projects.length > 0 && (
                <View>
                    ...
                    {projects.map((project) => (
                        <View key={project.id}>
                            <Text style={styles.headingFour}>{project.projectTitle}<Link style={{marginLeft:4,paddingLeft:4, color: '#8B5CF6', fontSize:8}} href={project.projectUrl}>{"Visit"}</Link></Text>
