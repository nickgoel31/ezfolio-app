...
export const MyDocument = ({userPage, experiences, projects,awards,education}:{userPage:UserPage, experiences:Experience[], projects:Project[], education:Education[],awards:Award[]}) =>(
