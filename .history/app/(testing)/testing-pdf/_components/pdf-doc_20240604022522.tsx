...
import { EducationResume, ExperienceResume, SkillResume } from '@/app/(dashboard)/resume-generator/_components/nsiu-resume-form';
import { z } from 'zod';
...
export const MyDocumentUNSI = ({values,skills, experiences,education}:{values: z.infer<typeof resumeSchema>,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[]}) => (
<Document creator='Ezfolio' producer='Ezfolio' title={`${values.}'s Resume`} subject={`Created with Ezfolio`}>
    <Page size="A4" style={styles.page} wrap={false}>
      <View style={styles.flexDiv}>
        <View>
            <Text style={styles.userName}>{userPage?.title.split(" ")[0]}</Text>
