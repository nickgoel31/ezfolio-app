...
export const MyDocument = ({userPage}:{userPage:UserPageType}) =>(
    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.flexDiv}>
        ...
        <View style={styles.profilePic}>
            <Image style={styles.picture} src={userPage.} />
        </View>
      </View>
      <View style={styles.section}>
        <Svg width={"100%"} height={2} style={{backgroundColor: "gray", marginTop: 20, marginBottom: 20}}/>
      </View>
      <View style={styles.section}>
