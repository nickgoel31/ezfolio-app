      ...
      <View style={styles.flexDivSection}>
        <View style={styles.flexContainerMinority}>
            ...
            <View style={{marginVertical:20}}>
                ...
                {/* {awards.map((award) => (
                    <View key={award.id}>
                        <Text style={styles.listItem}>{award.awardTitle}</Text>
                ...
                <View>
                        <Text style={styles.headingFour}>Web Design</Text>
                        <Text style={styles.listItem}>FreecodeCamp</Text>
                        <Text style={styles.listItem}>{"2024"}</Text>
                </View>
            </View>
        </View>
        {/* <View style={styles.section}>
                    ...
                    {education.map((edu) => (
                        <View key={edu.id}>
                            <View style={styles.flexDiv}>
                                ...
                                <Text style={styles.date}>{edu.startDate.getFullYear()} - {edu.startDate.getFullYear()}</Text>
                            </View>
