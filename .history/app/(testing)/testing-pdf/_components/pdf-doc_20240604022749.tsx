...
export const MyDocumentUNSI = ({values,profilePic,skills, experiences,education}:{values: z.infer<typeof resumeSchema>,profilePicUrl:string,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[]}) => (
