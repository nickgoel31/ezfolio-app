...
export const MyDocumentUNSI = ({values,profilePic,skills, experiences,education}:{values: z.infer<typeof resumeSchema>,profilePic:HTMLInputElement,skills: SkillResume[], experiences:ExperienceResume[], education:EducationResume[]}) => (
