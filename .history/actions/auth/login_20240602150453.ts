...
export const login = async (values: z.infer<typeof loginFormSchema>) => {
    ...
    if(existingUser.twoFactorAuthentication === true) {
        await twoFactorAuthenticationInDB(existingUser.email)
        set2FACookieInHeader()
        return {success: "Please Enter the 2FA Code sent to your email!", successCode:"SUC_2FA_SENT"}
    }
