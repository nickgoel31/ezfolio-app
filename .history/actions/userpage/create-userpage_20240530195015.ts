...
export const createUserPageInDB = async (values:z.infer<typeof onBoardingSchema>, projects: ProjectStateType[],username:string, imageUrl:string|undefined,currentThemeSelected:string,) => {
