...
const UserButton = ({username}:{username:string}) => {
  ...
  return (
    <div className='w-full rounded p-1 hover:bg-foreground/10 transition flex items-center justify-center'>
        <Popover>
            <PopoverTrigger className='w-full h-full'>
                <div className='flex items-center justify-center text-xs lg:text-sm font-medium w-full'>
