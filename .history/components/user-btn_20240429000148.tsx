...
const UserButton = ({username,userId}:{username:string,userId:string}) => {
    const handleSignout = () => {
        logout()
        redirect("/showcase")
    }

    const isAdmin = userId === "ff287bbf-0a19-4e74-8804-b5bc52e024c6"
        ...
        <Popover>
            ...
            <PopoverContent className='z-[120]'>
                <div className='flex flex-col w-full space-y-1'>
                    ...
                    <Link href={"/admin"} className='flex items-center gap-2 w-full text-sm font-medium rounded hover:bg-foreground/5 p-2'>
                        <CoffeeIcon size={17}/>
                        <p>Admin Tools</p>
                    </Link>
                </div>
