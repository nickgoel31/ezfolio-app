...
const ImageUpload = () => {
  ...
  return (
    <div className="w-full">
        ...
        {imageUrl ? (
                        <div className='border p-2 rounded overflow-hidden h-full w-full max-h-32 object-contain'>
                            <Image src={imageUrl} alt='page-pic' width={1000} height={1000} className='h-full w-full '/>
                        </div>
                    ):(
