...
import { AlignCenter, AlignJustify, AlignLeft, AlignRight, Bold, Code, Heading1, Heading2, Heading3, Heading4, Highlighter, Italic, List, ListOrdered, Quote } from 'lucide-react'
  ...
  return (
    <ContextMenuContent>
        ...
        <div className='w-full rounded-md p-3 grid grid-cols-4 items-center gap-2'>
            ...
            {/* Underline */}
            <Toggle size={"sm"} className='border' pressed={editor.isActive("highlight")} onPressedChange={() => editor.chain().focus().toggleHighlight({color:'#ffc078'}).run()}>
                <Highlighter size={20}/>
            </Toggle>
