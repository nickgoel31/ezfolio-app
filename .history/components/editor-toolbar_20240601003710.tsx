...
import { Bold, Code, Heading1, Heading2, Heading3, Heading4, Italic, ListOrdered, Quote } from 'lucide-react'
  ...
  return (
    <ContextMenuContent>
        ...
        <ContextMenuSub>
          ...
          <ContextMenuSubContent className="w-48">
            <ContextMenuItem>
                <Toggle size={"sm"} className='w-full' pressed={editor.isActive("heading", {level:1})} onPressedChange={() => editor.chain().focus().toggleOrderedList({level:1}).run()}>
                    <ListOrdered size={20}/>
                    <ContextMenuShortcut>⌘Alt1</ContextMenuShortcut>
                </Toggle>
            </ContextMenuItem>
