  ...
  return (
    <>
        {imageUrl && (
          ...
          className="w-fit"
          appearance={{
              button: `p-2 px-4 w-fit rounded-md cursor-pointer bg-foreground/10 hover:bg-primary-foreground-hover text-sm font-medium transition-all duration-200 ease-in-out h-fit`,
