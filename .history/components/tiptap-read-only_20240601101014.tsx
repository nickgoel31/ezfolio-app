...
export const TiptapQuestionReadOnly = ({description,isPostCreator,questionPostId}:{description:string,isPostCreator:boolean,questionPostId:string}) => {
  ...
  const { toast } = useToast()
    ...
    const editor = useEditor({
      ...
      function onSubmit () {
        const savedQuesDesc = editor?.getHTML() || ""
...
export const TiptapAnswerReadOnly = ({description,isPostCreator,answerPostId}:{description:string,isPostCreator:boolean,answerPostId:string}) => {
  const [editState,setEditState] = useState(false)
  const [ansState, setAnsState] = useState(description)
    const editor = useEditor({
      ...
      function onSubmit () {
        ...
        updateAnswerInDB(savedAnsDesc,questionPostId, userId)
        .then(d => {
          if(d.success) {
            toast({
              title: "Question Updated",
