        ...
        {userPage.skills.length > 0 && (
          ...
          <div className='grid grid-cols-3 gap-8'>
            {userPage.skills.map((skill,index) => (
              ...
              <div className='rounded-full p-3 ' style={{color: `${currentAdvancedPortfolioTheme.primaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioThemeColor.primaryBgColor}`}} >
                <Hand />
              </div>
