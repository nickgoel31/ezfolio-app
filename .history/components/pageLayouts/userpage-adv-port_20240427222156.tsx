  ...
  return (
    ...
    <div className='w-full min-h-full relative flex flex-col items-center justify-start' style={{fontFamily: `${currentFont.family}`,backgroundColor:`${currentAdvancedPortfolioThemeColor.primaryBgColor}`}}>
      ...
      {(experiences.length > 0 || userPage.skills.length > 0) && (
        <div className='  w-full flex px-32 mx-auto space-x-14 py-16 ' style={{color: `${currentAdvancedPortfolioThemeColor.secondaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.secondaryBgColor}`}}>
