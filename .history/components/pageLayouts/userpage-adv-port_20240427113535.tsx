          ...
          <Avatar className='h-20 w-20 mb-3'>
              {userPage.pagePicUrl ? (
                <>
                  ...
                  <AvatarFallback className='uppercase text-2xl font-semibold' style={{color: `${currentAdvancedPortfolioTheme.secondaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.primaryBgColor}`}}>{title.charAt(0)}</AvatarFallback>
                </>
              ):(
