        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3 relative'>
              ...
              <div className='absolute bottom-[-90%] left-4 flex items-end'>
                ...
                {currentAdvancedPortfolioTheme.id === 1 && <Image src={"/arrow-black.png"} alt='arrow'  width={50} height={50} className='scale-x-[-1] md:scale-x-[1.01]'/>}
                {currentAdvancedPortfolioTheme.id === 2 && <Image src={"/arrow-white.png"} alt='arrow'  width={50} height={50} className='scale-x-[-1] md:scale-x-[1.01]'/>}
...
export const UserpageAdvancedPortfolioPageNatureTheme = ({userPage,title,bio,id,projects,experiences,skills,colorScheme,currentFont, pageLayout, hasSocialLinks, fontWeight, vipTag,uniqueTag, currentAdvancedPortfolioTheme}:Props) => {
  ...
  return (
    <>
    <body className='w-full relative flex flex-col items-center justify-start' style={{fontFamily: `${currentFont.family}`}} >
      <div className='w-full h-full flex-col lg:flex-row flex  ' style={{fontFamily: `${currentFont.family}`}}>
