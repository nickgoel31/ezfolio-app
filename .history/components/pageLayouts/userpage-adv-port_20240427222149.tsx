        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3 relative'>
              <Link href={`${userPage.linkedinUrl}`} target='_blank'>
                <Button variant={'outline'} className='' style={{color: `${currentAdvancedPortfolioThemeColor.primaryBgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.accentColor}`}}>Talk to me</Button>
              </Link>
