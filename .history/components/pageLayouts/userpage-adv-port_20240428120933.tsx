        ...
        <div className='flex flex-col space-y-2  flex-[1]'>
            ...
            <div className='flex gap-4 items-center pt-3 relative'>
              ...
              <div className='absolute bottom-[-90%] left-4 flex items-end'>
                ...
                {currentAdvancedPortfolioTheme.id === 1 && <Image src={"/arrow-black.png"} alt='arrow'  width={50} height={50} className='scale-x-[-1] lg:scale-x-0'/>}
                {currentAdvancedPortfolioTheme.id === 2 && <Image src={"/arrow-white.png"} alt='arrow'  width={50} height={50} className='scale-x-[-1] lg:scale-x-0'/>}
