...
const UserpageAdvancedPortfolioPage = ({userPage,title,bio,id,projects,experiences,skills,colorScheme,currentFont, pageLayout, hasSocialLinks, fontWeight, vipTag,uniqueTag, currentAdvancedPortfolioTheme}:Props) => {
  return (
    ...
    <div className='sticky bottom-0 w-full  z-[200] flex items-center justify-center shadow-md backdrop-blur-lg py-3 ' style={{color: `${currentAdvancedPortfolioTheme.primaryFgColor}`, backgroundColor:`${currentAdvancedPortfolioTheme.primaryBgColor}90`, border: `2px ${currentAdvancedPortfolioTheme.primaryFgColor}`}}>
