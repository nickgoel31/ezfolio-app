    ...
    <body className='w-full relative flex flex-col items-center justify-start' >
      <div className='w-full h-full flex-col lg:flex-row flex  '>
        <div className='flex-[3] w-full h-full relative'>
          ...
          <div className='w-full z-[4] flex flex-col items-start justify-center px-4 lg:px-32 py-32 space-y-16'>
            <div className='space-y-4'>
              ...
              <h1 className='text-5xl font-semibold text-white drop-shadow-lg leading-relaxed' >{userPage.tagline}</h1>
