  ...
  return (
    <div className='w-full rounded-md border border-input bg-background p-3 flex items-center gap-2'>
        ...
        <DropdownMenuContent>
            ...
            <DropdownMenuItem>
                <Toggle size={"sm"} pressed={editor.isActive("heading", {level:3})} onPressedChange={() => editor.chain().focus().toggleHeading({level:1}).run()}>
                    <Heading3 size={20}/>
                </Toggle>
            </DropdownMenuItem>
            <DropdownMenuItem>
                <Toggle size={"sm"} pressed={editor.isActive("heading", {level:4})} onPressedChange={() => editor.chain().focus().toggleHeading({level:2}).run()}>
                    <Heading4 size={20}/>
                </Toggle>
            </DropdownMenuItem>
        </DropdownMenuContent>
