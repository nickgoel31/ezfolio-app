...
import { AlignCenter, AlignJustify, AlignLeft, AlignRight, Bold, Code, Heading1, Heading2, Heading3, Heading4, Italic, List, ListOrdered, Quote } from 'lucide-react'
  ...
  return (
    <ContextMenuContent>
        ...
        <div className='w-full rounded-md p-3 grid grid-cols-4 items-center gap-2'>
            ...
            {/* Code */}
            <Toggle size={"sm"} className='border' pressed={editor.isActive("codeBlock")} onPressedChange={() => editor.chain().focus().toggleCodeBlockLow().run()}>
                <Code size={20}/>
            </Toggle>
            ...
            {/* Underline */}
            <Toggle size={"sm"} className='border' pressed={editor.isActive("underlin")} onPressedChange={() => editor.chain().focus().toggleStrike().run()}>
                <Quote size={20}/>
            </Toggle>
