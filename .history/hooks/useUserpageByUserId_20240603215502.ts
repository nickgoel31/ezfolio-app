...
// Test - temporarily remove useState
export const useCurrentUserpage = () => {
    ...
    useEffect(() => {
      async function getuserpage() {
        ...
        // setUserpage(curUserpage); // Comment out temporarily
        console.log("Fetched userpage:", curUserpage); // Add for debugging
      }
  
      getuserpage();
    }, []);
  
    return /* userpage */; // Uncomment if needed for debugging
  };
